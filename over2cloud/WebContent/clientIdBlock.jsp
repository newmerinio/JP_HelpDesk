		...
		<div class="pop_content">
			...
			<div class="pop_up_content_inner">
				<div class="pop_up_content_inner_sub">
					<h1>Oops Error In Client Id Blocked, Please Contact the Over2Cloud.com team .!!!!!!!! </h1>
					<div class="pop_text"><p>Your Account has been blocked Due To <s:property value="%{errorMessege}"/>  </p></div>
