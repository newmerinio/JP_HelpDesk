		...
		<div class="pop_content">
			...
			<div class="pop_up_content_inner">
				<div class="pop_up_content_inner_sub">
					<h1>Oops Error In Chunk Space!!!!!!!! </h1>
					<div class="pop_text"><p>Problem In Chunk Space, Please Contact the Over2Cloud.com team .</p></div>
					<div class="pop_text"><p><s:property value="%{errorMessege}"/> </p></div>
					<div class="pop_up_forgot"><a href="javascript:void();">please contact our <span>support team</span>, for problems of any sort</a></div>
