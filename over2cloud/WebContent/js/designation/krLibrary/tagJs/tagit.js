...
(function ($) {
    $.widget("ui.tagit", {
        ...
        _create:function () {
            ...
            //add the html input
            this.element.html('<li class="tagit-new"><input class="tagit-input"  type="text" name="tags" value="'+$("#tagsssssss").val()+'"/></li>');
        ...
        _addTag:function (label, value) {
            ...
            tag.element = $('<li class="tagit-choice"'
                ...
                + label + '<div style="display:none;">,</div><a class="tagit-close">x</a></li>');
