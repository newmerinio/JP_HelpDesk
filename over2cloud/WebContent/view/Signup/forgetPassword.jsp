...
<body>
<div style="height:auto; width:auto; float:left;margin-left: 60px;">

  <s:form name="formone" id="formOne" id="AddRegistation_Url" action="newPassReq"  theme="simple" theme="simple"  method="post">
...
<div class="input-name2">Account ID : </div>
<div class="input-container2"> 
	<s:textfield name="accountID" id="accountID"  cssClass="input4" maxlength="50"  placeholder="Account ID"></s:textfield>
</div>
</div>
<div class="clear"></div>
<div class="input-main-container2"> 
<div class="input-name2">Username : </div>
...
<div class="clear"></div>
<div class="input-main-container2"> 
<div class="input-name2"> Mobile No : </div>
...
<div class="input-main-container2"> 
<div class="input-container2"> OR </div>
</div>
</div>
...
<div class="input-main-container2"> 
<div class="input-name2"> Email ID : </div>
<div class="input-main-container2"><div class="input-container2">
...
<div class="input-container2">
  ...
  <div style="float:left; width:110px"><s:textfield name="j_captcha_response" cssStyle="margin-left: -34px" size="10" maxlength="10" id="j_captcha_response"  cssClass="input5"  onfocus="javascript:if(this.placeholder=='Enter the code as shown') this.placeholder = '';" onblur="javascript:if(this.placeholder=='') this.placeholder = 'Enter the code as shown';" placeholder="Enter the code" onblur="return oncheckcapacha('j_captcha_response');"/></div><!--
