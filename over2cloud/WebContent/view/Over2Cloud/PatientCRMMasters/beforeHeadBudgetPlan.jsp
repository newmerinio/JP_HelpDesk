...
function addBudgetPlan(){
	...
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/patientCRMMaster/beforeAddBudgetPlan.action",
...
function getGridView()
{
	$.ajax({
 		type :"post",
 		url :"view/Over2Cloud/patientCRMMaster/viewConfiguredBudgetPlan.action",
...
<div class="list-icon">
 ...
 <div class="clear"></div>
	...
	<sj:a id="addButton" title="Add Budget Plan" button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addBudgetPlan();">Configure Budget</sj:a>
    </td>   
	</tr></tbody></table>
	</div>
	</div>
