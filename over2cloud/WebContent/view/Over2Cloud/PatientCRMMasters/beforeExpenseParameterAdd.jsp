...
<body>
	...
	<div class="middle-content">
		...
		<div class="list-icon">
			<div class="head">Expense Parameter</div>
			<div class="head">
			...
			<div class="container_block">
				<div style="float: left; padding: 20px 1%; width: 98%;">
					<s:form id="formone" name="formone"
						...
						action="addExpenseParameterDetails" theme="css_xhtml" method="post"
    ...
    padding: 1%; overflow: auto; "  class="container_block" >
                             <s:iterator value="packageFields" status="counter" begin="0">
                      <%--        <s:if test="%{mandatory}">
