...
<body>
<div class="list-icon">
	 <div class="head">AdhocAssociate</div>
 ...
 <div class="clear"></div>
	...
	<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addAdhocAssociate();">Add</sj:a>
    </td>   
	</tr></tbody></table>
	</div>
	</div>
...
var selRowIds = jQuery('#gridAdhocAssociate').jqGrid('rowselect', 'selarrrow');
...
function deleteRow()
{
	  var status = jQuery("#gridAdhocAssociate").jqGrid('getCell',row,'status');
//	  alert(status);
	if(row==0)
	{
