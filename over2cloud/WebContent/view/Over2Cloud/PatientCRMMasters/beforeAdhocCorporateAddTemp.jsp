...
<script type="text/javascript">
	function closeAddTemp2() {
		$("#addDialog").dialog('close');
		backToPatientForm2();
	}
</script>
<script type="text/javascript">
function backToPatientForm2() {
	 $("#addNewCorporateDialog").dialog('close');
	 $("#formCorporateDiv").val("");
}
		...
		<div class="border">
			<div class="container_block">
				<div style="float: left; padding: 20px 1%; width: 98%;">
					<s:form id="formAdhocCorporate" name="formone"
						...
						<div class="clear">
							<div style="padding-bottom: 10px; margin-left: -76px"
								...
								<sj:a cssStyle="margin-left: 276px;margin-top: -58px;"
									button="true" href="#" value="Back" onclick="closeDialogById('addNewCorporateDialog'); backToPatientForm2();"
