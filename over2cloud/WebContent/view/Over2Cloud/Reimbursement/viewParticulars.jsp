...
<body>
<div class="list-icon"><div class="clear"></div><div class="head"><h4>Particulars >>View</h4><s:property value=""/></div></div>
<div class="clear"></div>
<div class="rightHeaderButton">
<sj:a cssClass="btn createNewBtn"  onclick="addParticulars()" button="true" buttonIcon="ui-icon-plus"> Create New Particulars </sj:a>
 </div>
