...
<div class="middle-content">
    <div class="list-icon">
        <div class="head"><h4>Purpose >>Details</h4><s:property value="%{}"/></div>
    </div>
    <div class="clear"></div>
    <div style="min-height: 10px;  auto; width: 100%;"></div>
   
    <div class="border" style="height: 50%">
      <div class="secHead"><h4>Purpose >> Add</h4><s:property value=""/></div>
        <div style="width: 100%; center; padding-top: 10px;">
		 
		        <s:form id="formone"  action="addPurposeMaster" theme="css_xhtml" method="post" enctype="multipart/form-data">
