...
function createTaskType()
{
	...
	$("#data_part").load("<%=request.getContextPath()%>/view/Over2Cloud/DAROver2Cloud/beforeTaskTypeAddAction.action");
}
function gotoDashboard(){
	$("#form_reg").load("<%=request.getContextPath()%>/view/Over2Cloud/DAROver2Cloud/dashboard.action");}
...
<div class="list-icon">
	 <div class="head">Task Type</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div> 
</div>
<div style=" float:left; width:100%;">

<%if(userRights.contains("ttma_VIEW")){ %>
 <div class="clear"></div>
  <div class="clear"></div>
    <div style=" float:left; padding:10px 1%; width:98%;">
    <%if(userRights.contains("ttma_MODIFY")){ %>
    ...
    <%if(userRights.contains("ttma_DELETE")){ %>
	...
	<%if(userRights.contains("ttma_ADD")){ %>
...
<s:url id="taskGridDataView" action="taskGridDataView"></s:url>
<s:url id="deleteTaskGrid" action="deleteTaskGrid" />
<s:url id="modifyTaskGrid" action="modifyTaskGrid" />
<center>
<sjg:grid 
		  id="gridedittable"
          href="%{taskGridDataView}"
          gridModel="viewList"
          navigator="true"
          loadonce="true"
          navigatorAdd="false"
          ...
          editurl="%{deleteTaskGrid}"
          editurl="%{modifyTaskGrid}"
          shrinkToFit="false"
