...
<script type="text/javascript">
	function backToView() {
		...
		$.ajax({
					type : "post",
					url : "view/Over2Cloud/CorporatePatientServices/cpservices/viewRelationshipMasterHeader.action",
...
<body>
	...
	<div class="middle-content">
		...
		<div class="list-icon">
			<div class="head">Relationship Master Details</div>
			<div class="head">
			...
			<div class="container_block">
				<div style="float: left; padding: 20px 1%; width: 98%;">
					<s:form id="formone" name="formone"
						...
						action="addRelationshipMasterDetails" theme="css_xhtml" method="post"
