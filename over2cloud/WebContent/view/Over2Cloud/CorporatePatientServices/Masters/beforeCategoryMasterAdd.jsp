...
<script type="text/javascript">
	function backToView() {
		...
		$.ajax({
					type : "post",
					url : "view/Over2Cloud/CorporatePatientServices/cpservices/viewCategoryMasterHeader.action",
...
<body>
	...
	<div class="middle-content">
		...
		<div class="list-icon">
			<div class="head">Category Master Details</div>
			<div class="head">
			...
			<div class="container_block">
				<div style="float: left; padding: 20px 1%; width: 98%;">
					<s:form id="formone" name="formone"
						...
						action="addCategoryMasterDetails" theme="css_xhtml" method="post"
				...
				<s:iterator value="packageFields" status="status">
		     	...
		     	<span id="complSpan" class="pIds" style="display: none; "><s:property value="%{key}"/>#<s:property value="%{value}"/>#<s:property value="%{colType}"/>#<s:property value="%{validationType}"/>,</span>
				    ...
				    <s:if test="%{mandatory}"><span class="needed"></span></s:if>
				             ...
				             <s:if test="%{key == 'cat_type'}">
				         		<s:select 
                                      id="%{key}"
                                      name="%{key}" 
                                      list="{'Patient','Referral','Corporate'}"
                                      headerKey="-1"
