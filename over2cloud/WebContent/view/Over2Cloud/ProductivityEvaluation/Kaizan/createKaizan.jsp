...
<div class="page_form">
  ...
  <s:form id="addData" name="addData" action="kaizenAddAction" namespace="/view/Over2Cloud/ProductivityEvaluationOver2Cloud" theme="simple"  method="post" enctype="multipart/form-data" >
    <center>
		 ...
		 <ul>
	        ...
	        <sj:submit 
     		  	  ...
     		  	  />
     		  	   <sj:a 
						button="true" href="#"
						onclick="resetTaskName('addData');"
						>
						Reset
					</sj:a>
     		  	  <sj:a 
						button="true" href="#"
						onclick="viewkaizen('moduleName');"
						>
						Back
					</sj:a>
	        </div>
