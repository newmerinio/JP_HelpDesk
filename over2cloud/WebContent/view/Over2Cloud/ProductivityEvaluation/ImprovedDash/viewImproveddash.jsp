...
<sj:dialog 
	...
	title="Take Action"
>
<div id="actionDataDiv1" align="center">
</div>
</sj:dialog>
<div class="clear"></div>
					       ...
					       <tr><td class="pL10">   
							 <sj:a id="searchButton"  title="Search" buttonIcon="ui-icon-search" cssStyle="height:25px; width:32px"  cssClass="button" button="true"  onclick="searchRow()"></sj:a>
						 	 <sj:a id="refButton"  title="Refresh" buttonIcon="ui-icon-refresh" cssStyle="height:25px; width:32px"  cssClass="button" button="true"  onclick="reloadRow()"></sj:a>
					      	 <sj:a id="takeAction"  button="true"   cssClass="button" onclick="takeActionImproved('moduleName');">Take Action</sj:a>
					      </td></tr></tbody>
					  </table>
				  </td>
				  <td class="alignright printTitle">
						<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewDataImproved('moduleName');">Add</sj:a>
				  </td>
			</tr>
		</tbody>
	</table>
...
<s:url id="veiwImproved" action="viewImprovedData" escapeAmp="false">
<s:param name="moduleName" value="%{moduleName}"></s:param>
</s:url>
<s:url id="viewModifyImproved" action="viewModifyAction" />
<sjg:grid 
		  id="gridedittable"
          href="%{veiwImproved}"
