...
Online Oragnization Details</div></div>
...
<s:url id="OrganizationalUrl" action="Organizationalclient.action"/>
    <sjg:grid
    	id="onlinegridview"
    	caption="Online Oragnization Details"
    	dataType="json"
    	href="%{OrganizationalUrl}"
    	pager="true"
    	navigator="true"
    ...
    >
        ...
        <sjg:gridColumn name="orgname"  width="150" index="orgname" title="Orgnization Name" editable="true" edittype="text" sortable="true" align="center"/>
    	<sjg:gridColumn name="orgusername" width="150" index="orgusername" title="Registered BY" editable="true" edittype="text"  sortable="false" align="center"/>
    	<sjg:gridColumn name="city" width="150" index="city" title="City" editable="true" edittype="text"  sortable="false" align="center"/>
    	...
    	<sjg:gridColumn name="accounttype" width="240" index="accounttype" title="Account Type" editable="true" edittype="text"  sortable="false" align="center"/>
