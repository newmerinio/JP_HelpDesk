...
Online Registration Details</div></div>
...
<s:url id="onLineclientUrl" action="onLineclien.action"/>
    <sjg:grid
    	id="onlinegridview"
    	caption="Online Registration Details"
    	dataType="json"
    	href="%{onLineclientUrl}"
    	pager="true"
    	navigator="true"
    	...
    	shrinkToFit="false"
    >
        <sjg:gridColumn name="accountid" width="60" index="accountid" title="Account Id" sortable="false" align="center"/>
    	...
    	<sjg:gridColumn name="orgusername" width="130" index="orgusername" title="Registered BY" editable="true" edittype="text"  sortable="false" align="center"/>
    	<sjg:gridColumn name="city" width="100" index="city" title="City" editable="true" edittype="text"  sortable="false" align="center"/>
    	 <sjg:gridColumn name="country" width="150" index="country" title="Country" sortable="false" align="center"/>
    	 <sjg:gridColumn name="signupstatus" width="150" index="signupstatus" title="SignUp Status" sortable="false" align="center"/>
    	<sjg:gridColumn name="accounttype" width="250" index="accounttype" title="Account Type" editable="true" edittype="text"  sortable="false" align="center"/>
