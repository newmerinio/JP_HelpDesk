...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
        	$.ajax({
        	    type : "post",
        	    url : "/over2cloud/view/Over2Cloud/feedback/dashboard_Graph/FeedbackChartsJson.action?fromDate="+$("#sdate").val()+"&toDate="+$("#edate").val(),
        	    type : "json",
    			...
    			title: ' Departmentwise Stats of Issues, Action & Capa  ',
                description: ' ',
                    ...
                    [
                        {
                            ...
                            series: [
										{ dataField: 'Issue', displayText: 'Issues' },
	                                    { dataField: 'Action', displayText: 'Action' },
	                                    { dataField: 'CAPA', displayText: 'CAPA' }
