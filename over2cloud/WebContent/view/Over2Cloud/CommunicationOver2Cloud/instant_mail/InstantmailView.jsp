...
<div class="list-icon">
	<div class="head">Instant Message</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
...
--><sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addinstantmsggg();">Add</sj:a>
</td> 
</tr></tbody></table></div></div>
<s:url id="viewInstantMessageGrid" action="viewInstantMsgDataGrid" >
</s:url>
<center>
<sjg:grid 
		  id="gridedittable"
