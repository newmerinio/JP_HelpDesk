...
<div class="list-icon">
	<div class="head">Auto SMS Report</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
...
--<!-- ><input class="btn createNewBtn" value="Add " type="button" onclick="add();"> -->
<div class="clear"></div>
</div>
<div class="clear"></div>
...
<s:url id="AutoPushReportGrid" action="beforeAutoPushReportView" >
</s:url>
<center>
<sjg:grid 
		  id="gridedittable"
          href="%{AutoPushReportGrid}"
          ...
          autowidth="true"
          >
          <s:iterator value="viewAutoPushReportGrid" id="viewAutoPushReportGrid" >  
		<sjg:gridColumn 
		name="%{colomnName}"
		index="%{colomnName}"
		title="%{headingName}"
