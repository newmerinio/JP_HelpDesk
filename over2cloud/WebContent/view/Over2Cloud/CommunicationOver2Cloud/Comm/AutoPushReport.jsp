...
<body>
<div class="list-icon">
	<div class="head"><h3>Auto SMS Report</h3></div>
	</div>
	<div class="clear"></div>
...
<s:form id="formtwo" name="formtwo" namespace="/view/Over2Cloud/CommunicationOver2Cloud/Comm" action="getAutoPushReport" theme="css_xhtml"  method="post" >
...
class="form_menu_inputtext" style="margin: 0px 0px 10px; width: 230px; height: 60px;"/>
					     </div></div>
					    </s:else>
