...
<s:form id="formone" name="formone" namespace="/view/Over2Cloud/CommunicationOver2Cloud/Comm" action="insertConfirmationScheduleMsgData" theme="css_xhtml"  method="post"enctype="multipart/form-data" >
