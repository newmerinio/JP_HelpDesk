...
function addConfigure()
{
	...
	$.ajax({
	    type : "post",
	    url : "/over2cloud/view/Over2Cloud/ConfigureUtility/addconfigureUtility.action",
	    success : function(data) {
       		$("#data_part").html(data);
...
<div class="list-icon">
	<div class="head">Configure</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
...
<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addConfigure();">Add</sj:a>
</td> 
</tr></tbody></table></div></div>
<s:url id="viewconfigureGrid" action="viewConfigureUtilityDataGrid" ></s:url>
<s:url id="viewModifyGrid" action="modifyConfigureUtility" >
...
<sjg:grid 
		  id="gridedittable"
          href="%{viewconfigureGrid}"
          gridModel="viewConfigureData"
          loadonce="ture"
          navigator="true"
          navigatorAdd="false"
          navigatorView="false"
          ...
          >
          <s:iterator value="viewConfigureUtilityGrid" id="viewConfigureUtilityGrid" >  
		<sjg:gridColumn 
		name="%{colomnName}"
		index="%{colomnName}"
		title="%{headingName}"
