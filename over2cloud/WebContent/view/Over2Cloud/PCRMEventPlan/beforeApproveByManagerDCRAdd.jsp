...
<div class="clear"></div>
<div class="border">
<s:form id="DCRform" name="DCRform" namespace="/view/Over2Cloud/patientCRMMaster" action="approveByManagerDCRAdd" theme="css_xhtml" method="post" enctype="multipart/form-data">
	...
	<table width="100%">
		<tr class="phead">
			<th colspan="4">Parameter Details</th>
		</tr>
		<tr class="MytabHead">
			<th>Sr. No</th>
			<th>Name</th>
	...
	<table width="100%">
		<tr >
			<th class="phead" colspan="4">ROI Details</th>
		</tr>
		<tr  class="MytabHead" >
			<th >Sr. No</th>
			<th >Name</th>
	...
	<div style="padding-bottom: 10px; margin-left: -76px" align="center">
		<sj:submit targets="level123" clearForm="true" value="Save" effect="highlight" effectOptions="{ color : '#FFFFFF'}"
			effectDuration="5000" button="true" onBeforeTopics="validate3"    onCompleteTopics="level1" /> &nbsp;&nbsp; 
		<sj:submit value="Reset" button="true" cssStyle="margin-left: 139px;margin-top: -43px;" onclick="reset('formone3');" />
   </div>
</s:form>
</div>
</center>
