...
function createSpecialityMaster()
{

	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/Text2Mail/beforeSpeciality.action",
...
<div class="list-icon">
<div class="head">Speciality</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
</div>
		...
		<tbody>
			<tr>
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="createSpecialityMaster();">Add</sj:a> 
...
<div class="clear"></div>
<s:url id="viewSpeciality" action="viewSpeciality" />
<s:url id="modifySpeciality" action="modifySpeciality" />
<center>
<sjg:grid 
		  id="gridBasicDetails"
          href="%{viewSpeciality}"
