...
function createSecKeyword()
{

	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/Text2Mail/beforeSecKeywordsAdd.action",
...
function getOnChangePrimaryData(searchFields)
{
	$.ajax({
	    ...
	    url : "view/Over2Cloud/Text2Mail/beforesecKeyView.action?searchFields1="+searchFields,
...
<div class="list-icon">
<div class="head">Secondary Keyword</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
</div>
		...
		<tbody>
			...
			<s:select  
				  ...
				  <td class="alignright printTitle">
				    ...
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="createSecKeyword();">Add</sj:a> 
