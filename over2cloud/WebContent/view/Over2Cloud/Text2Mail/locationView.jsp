...
function createLocationMaster()
{
	...
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/Text2Mail/beforeLocation.action",
...
<div class="clear"></div>
<div class="list-icon">
<div class="head">Location</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div>
</div>
		...
		<tbody>
			<tr>
				  ...
				  <td class="alignright printTitle">
				    <sj:a button="true" cssClass="button" cssStyle="height:25px;"  title="Add"  buttonIcon="ui-icon-plus" onclick="createLocationMaster();">Add</sj:a> 
				  </td>
			</tr>
		</tbody>
	</table>
...
<div class="clear"></div>
<s:url id="viewLocation" action="viewLocation" />
