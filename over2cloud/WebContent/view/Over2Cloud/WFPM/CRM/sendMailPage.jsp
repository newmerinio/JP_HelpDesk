...
<script type="text/javascript">
	...
	{
		  $("#takeActionGridId12121212221").dialog('open');
	  });
</script>
<script type="text/javascript">
function okdownload(){
...
<sj:dialog
          id="takeActionGridId12121212221"
          showEffect="slide"
          hideEffect="explode"
          autoOpen="false"
...
<div style="float:right; border-color: black; background-color: rgb(255,99,71); color: white;width: 90%; font-size: small; border: 0px solid red; border-radius: 8px;">
  <div id="errZone" style="float:left; margin-left: 7px"></div>
   <div id="excelError"></div>   
    ...
    <s:form id="formone" name="formone"  namespace="/view/Over2Cloud/WFPM/CRM" action="urlBeforemailSend" theme="simple"  method="post" enctype="multipart/form-data">
   ...
   --><div class="newColumn">
	...
	<div class="clear"></div>
       ...
       <s:if test="%{mandatory}"><span class="needed"></span></s:if>
			...
			<div class="newColumn" style="width: -1%; margin-top: -5%; margin-left: 60%;" id="mailtagdatapart">
