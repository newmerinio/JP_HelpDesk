...
function addPaymentSettlement()
{
	...
	else
	{
		...
		$.ajax({
		    type : "post",
		    url : "view/Over2Cloud/WFPM/ActivityPlanner/beforeAdvanceSettlementAdd.action?id="+ids+"&name="+name+"&actFor="+actFor+"&actType="+actType+"&from="+from+"&month="+month+"&comment="+comment+"&amount="+amount+"&ticket_no="+ticket_no,
		...
		<tbody>
			<tr>
				  ...
				  <td class="alignright printTitle">
				     <sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addPaymentSettlement();">Settlement</sj:a>
				  </td>
			</tr>
		</tbody>
	</table>
...
<s:url id="veiwTaskType" action="advanceViewSettlement" >
