...
<body>
	...
	<div style=" float:left; padding:10px 1%; width:98%;">
		...
		<sjg:gridColumn name="leadname" index="leadname" title="Lead Name" align="left" sortable="true" search="false" width="280" />
		...
		<sjg:gridColumn name="industry" index="industry" title="Industry" align="left" sortable="true" search="false" width="100" />
		<sjg:gridColumn name="subindustry" index="subindustry" title="Sub Industry" align="left" sortable="true" search="false" width="100" />
	</sjg:grid>
	</div>
</div>
</body>
