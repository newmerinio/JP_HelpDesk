...
<body>
	<div class="clear"></div>
	<div class="list-icon">
	<div class="head">SMS Template</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:60%; float: left;"></div><div class="head">Configuration</div>
	</div>
<!--<div class="page_title" style="height: 60px;"><img src="images/template.png" style="width: 50px;height: 50px;margin-left: 15px;margin-top: 8px;"/><h1 style="margin-top: -55px;margin-left: 35px;"> SMS Template Configuration</h1>
</div>
--><div class="container_block"><div style=" float:left;  width:100%;">
	...
	<div class="border" style="max-height: 100%;">
			...
			<s:hidden name="type" value="offering"></s:hidden>
				<table border="0" bordercolor="darkgray" rules="groups" cellpadding="10" cellspacing="10" style="width: 100%;">
					...
					<tr>
						...
						<td align="center"><s:select name='paramName' list="kpiList" listKey="id"  listValue="keyword" headerKey="-1" headerValue="-- Select Offering --" theme="simple"></s:select> </td>
						...
						<td align="center"><s:textfield name="paramLength" placeholder="Enter Key Length"  theme="simple" cssClass="textField"/></td>
					</tr>
