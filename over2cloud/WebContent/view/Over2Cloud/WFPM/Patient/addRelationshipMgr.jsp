...
<body>
	...
	<div class="head">Relationship Manager</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:60%; float: left;"></div><div class="head">Add</div>
	</div>
	<div class="clear"></div>
<div class="border">
	...
	<div style="float:left; border-color: black; background-color: rgb(255,99,71); color: white;width: 100%; font-size: small; border: 0px solid red; border-radius: 6px;">
        	...
        	<br>
	<s:form id="formone" name="formone" namespace="/view/Over2Cloud/WFPM/Patient" action="relationshipMgrSave" theme="css_xhtml"  method="post"enctype="multipart/form-data" >
    <div class="menubox">
   	<s:iterator value="clientDropDown" status="counter">
	    <s:if test="%{mandatory}">
         ...
         <!-- Drop down offering -->
			...
			<div class="newColumn">
			<div class="leftColumn1">Relationship Manager:</div>
			<div class="rightColumn1">
			<span class="needed"></span>
			<s:select 
		                              id="relmgrname"
		                              name="name" 
		                              list="#{'-1':'Select Manager'}"
		                              cssClass="select"
		                              cssStyle="width:82%"
		                              >
		                  	</s:select>
