...
function fetchLastStatus(id, offeringId)
{
	...
	$.ajax({
		type : "post",
		url  : "view/Over2Cloud/WFPM/Patient/fetchLastStatusForOffering.action",
...
<div class="middle-content">
	...
	<div class="border">
	<s:form id="formClientTakeaction" name="formClientTakeaction" cssClass="cssn_form" namespace="/view/Over2Cloud/WFPM/Patient" 
		action="takePreventiveActionOnClient" theme="simple"  method="post" enctype="multipart/form-data" >
			...
			<div class="newColumn">	
				...
				<div class="rightColumn1">
					...
					<s:select 
						...
						cssClass="select"
                        cssStyle="width:82%"
                        onchange="fetchLastStatus(%{clientId},this.value);"
						>
					</s:select>
				</div>
			</div>	
