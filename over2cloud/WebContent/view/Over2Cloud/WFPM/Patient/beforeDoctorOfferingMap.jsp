...
<script src="<s:url value="js/PatientWFPM/beforeDocOfferingMap.js"/>"></script>
...
<body>
	...
	<div class="list-icon">
		<div class="list-icon">
		<div class="head">
		<div id="Cid" class="head">Doctor Offering Map</div><div class="head">
