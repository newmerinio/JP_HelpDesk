...
<script src="<s:url value="js/PatientWFPM/beforepatientView.js"/>"></script>
</head>
...
<body>
	...
	<div class="list-icon">
		<div class="list-icon">
		<div class="head">
		<div id="Cid" class="head">Configure Activity Escalation</div><div class="head">
