...
<br>
	...
	<div style="float: left; width: 100%;">
			<div class="leftColumn2" style="margin-right: 906px;margin-top: 8px;">Meeting Agenda:</div>
			<div class="rightColumn2"><span class="needed" style="margin-left: 137px;margin-top: -19px;"></span>
			 <s:textarea name="agendaMOM"  id="agendaMOM" cssClass="textField2" cssStyle="margin-left: -620px;margin-top:-19px;width: 308px;"/>
			</div>
		</div>   
...
">Discussion:</div>
    ...
    margin-top: -20px;
"></span>
			     <s:textarea name="discussionMOM" cssClass="textField2" cssStyle="margin:0px 0px 10px 0px;margin-left: 606px;margin-top: -29px;width: 306px;"/>
			</div>
		</div> 
		
		
		<div id="newDiv" style="float: right;width: 19%;">
			<sj:a value="+" onclick="adddiv('2')" button="true">+</sj:a></div>
...
">Discussion:</div>
    ...
    margin-left: 135px;
"></span>
			     <s:textarea name="discussionMOM" cssClass="textField2" cssStyle="margin:0px 0px 10px 0px;margin-right: 617px;margin-top: -18px;width: 312px;"/>
			</div>
		</div>  
 					<div class="clear"></div>
...
">Future Action:</div>
    ...
    margin-top: -23px;
"></span>
			     <s:textarea name="futureActionMOM"  id="futureActionMOM1" cssClass="textField2" cssStyle="margin: 0px 0px 10px; width: 311px; height: 31px;margin-right: 620px;margin-top: -23px;"/>
			</div>
		</div> 
