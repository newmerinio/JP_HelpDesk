...
<body>
	...
	<div style=" float:left; padding:10px 1%; width:98%;">
	 ...
	 <td class="alignright printTitle">
		 ...
		 <td class="alignright printTitle">
		 <s:radio list="#{'0':'KPI','1':'Offering'}" id="targetType" name="targetType" 
	 		onclick="viewTargetGrid()" value="%{targetType}" theme="simple"></s:radio>
	 		&nbsp;&nbsp;&nbsp;			
	     <sj:a button="true" cssClass="button" cssStyle="height:25px;" title="Add" buttonIcon="ui-icon-plus" 
     	   onclick="addTargetPage();">Allot Target</sj:a>
	</td>   
	</tr></tbody></table></div></div>

	<div id="dynaminDataPart">
		<!-- target data will come here dynamically *******************************************************************-->
	</div>	
