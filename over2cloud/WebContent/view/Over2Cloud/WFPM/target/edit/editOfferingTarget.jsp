...
<s:form id="formone" name="formone" namespace="/view/Over2Cloud/wfpm/target" action="editOfferingTarget" 
		...
		<table cellspacing="0" cellpadding="0" width="100%" >
			<tbody>
				<tr>
					...
					<td valign="middle" width="30%" align="center"><b>Offering</b></td>
	...
	<s:iterator value="targetForAlreadyMappedOffering" var="listVal" status="counter">
		<tr>
			<td bgcolor="#ffffff"
			...
			<table cellspacing="0" cellpadding="0" width="100%">
				<tbody>
					<tr>
						...
						<td width="5%">
							<s:checkbox cssClass="select" value="%{#listVal[3] != '' ? true : false }"
								fieldValue="%{#listVal[0]}" name="offeringId" theme="simple" />
						</td>
						...
						<td valign="middle" width="15%"><s:textfield
							...
							cssClass="textField" readonly="false" value="%{#listVal[2]}"
