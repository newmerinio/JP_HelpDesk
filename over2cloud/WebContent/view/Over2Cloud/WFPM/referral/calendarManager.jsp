...
function activityMethod(val)
{
	...
	{
		data = "1,2";
		headerName = 'Approval Activity for ';
	}
	else
	{
		headerName = 'Self Activity for ';
	}
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/WFPM/ActivityPlanner/fetchActivityEvent.action?contactId="+val+"&dataFor="+data+"&dsrStatus=1",
	    async:false,
	    success : function(subdeptdata) 
	    {
			activity = subdeptdata[0];
			eventd = subdeptdata[1];
	    },
	   error: function() 
	   {
	      alert("error");
...
function totalEvent(date,monthName,year)
{
	...
	{
		if(eventd[i].month==date1)
		{
			if(typeof eventd[i].flag!='undefined' && eventd[i].flag=='0')
			{
				a = 'Planned Event: ';
			}
			else if(typeof eventd[i].flag!='undefined' &&  eventd[i].flag=='1' )
			{
				a = 'Pending Event: ';
			}
			else if(typeof eventd[i].flag!='undefined' )
			{
				a = 'Approved Event: ';
			}
			act= act+1;
...
function checkOtherActivity(date,monthName,year)
{
	...
	for (var i =0;i<activity.length;i++)
	{
		if(activity[i].month==date1)
		{
			if(headerName=='Self Activity for ')
			{
			...
			else if(headerName=='Approval Activity for ')
			{
				if(activity[i].status=='Approved')
				{
					if(activity[i].dsr!='No')
					{
						if(activity[i].dsr_status=='Approved')
						{
							act+='<a href="#"><img src="images/check.jpg" title="DCR Approve" height="12" width="12" /><img src="images/check.jpg" title="DCR Approve" height="12" width="12" /></a>';
						}
						else if(activity[i].dsr_status=='Disapproved')
						{
							act+='<a href="#"><img src="images/red.png" title="DCR Disapprove" height="12" width="12" /><img src="images/red.png" title="DCR Disapprove" height="12" width="12" /></a>';
						}
						else
						{
							if(activity[i].dsr_flag=='1')
							{
								act+='<a href="#"><img src="images/black.png" onclick="disapproveDSR('+date+','+getMonthNumber(monthName)+','+year+','+activity[i].dsr +','+activity[i].id +')" title="DSR Fill" height="12" width="12" /><img src="images/black.png" title="Fill DSR" height="12" width="12" /></a>';
							}
							else
							{
								act+='<a href="#" onclick="alreadyTaken();"><img src="images/black.png" title="Fill DSR" height="12" width="12" /></a>';
							}
					    }
					}
					else
					{
						if(activity[i].flag=='1')
						{
							act+='<a href="#" onclick="disapproveRequest('+date+','+getMonthNumber(monthName)+','+year+','+activity[i].id +')"><img src="images/black.png" title="Take Action" height="12" width="12" /></a>&nbsp;';
						}
						else
						{
							act+='<a href="#" onclick="alreadyTaken();"><img src="images/black.png" title="Take Action" height="12" width="12" /></a>&nbsp;';
						}
					}
				}
				else
...
{
	alert("Action already taken on this activity");
}
function checkOtherEvent(date,monthName,year)
{
	...
	for (var i =0;i<eventd.length;i++)
	{
		if(eventd[i].month==date1)
		{
			if(headerName=='Self Activity for ')
			{
				if(eventd[i].status=='Approve')
				{
					if(eventd[i].flag!='0' && eventd[i].flag!='1')
					{
						if(eventd[i].dsr_status == 'Yes')
						{
							if(eventd[i].dsr_flag == '0' )
							{
								act+='<a href="#" onclick="showdsrFilledEvent('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +');"><img src="images/red.png" title="Filled DCR" height="12" width="12" /><img src="images/red.png" title="Filled DCR" height="12" width="12" /></a>';
							}
							else if(eventd[i].dsr_flag == '1')
							{
				...
				else if(eventd[i].status == 'Disapproved')
				{
					act+='<a href="#"><img title="Event Disapproved" src="images/close.gif"  /></a>&nbsp;&nbsp;&nbsp;';
				}
				else if(eventd[i].status=='Approved')
				{
					if(eventd[i].dsr_status == 'Yes' )
					{
						if(eventd[i].dsr_flag == '0' )
						{
							act+='<a href="#" onclick="showdsrFilledEvent('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +');" ><img src="images/black.png" title="Pending DCR Approve" height="12" width="12" /><img src="images/black.png" title="Pending DCR Approve" height="12" width="12" /></a>';
						}
						else if(eventd[i].dsr_flag == '1')
						{
							act+='<a href="#" showdsrFilledEvent('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +');"  ><img src="images/black.png" title="Waiting DCR Approve" height="12" width="12" /><img src="images/black.png" title="Waiting DCR Approve" height="12" width="12" /></a>';
						}
					} 
					else if(eventd[i].dsr_status=='Approved' )
					{
						act+='<a href="#" onclick="showdsrFilledEvent('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +');"  ><img src="images/check.jpg" title="DCR Approved" height="12" width="12" /><img src="images/check.jpg" title="DCR Approved" height="12" width="12" /></a>';			
					}
					else if(eventd[i].dsr_status=='Disapproved' )
					{
						act+='<a href="#" showdsrFilledEvent('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +');"  ><img src="images/red.png" title="DCR Dispproved" height="12" width="12" /><img src="images/red.png" title="DCR Dispproved" height="12" width="12" /></a>';			
					}
					else
					{
						act+='<a href="#" onclick="getdsrFillEvent('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +');" ><img src="images/black.png" title="Fill DCR" height="12" width="12" /></a>';
					}
				}
				else
				{
			...
			{
				if(eventd[i].status=='Approved')
				{
					if(eventd[i].dsr_status == 'Yes')
					{
						if(eventd[i].dsr_flag=='1')
						{
							act+='<a href="#" onclick="disapproveEventDCRRequest('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +')"  ><img src="images/black.png" title="DCR Approve Action" height="12" width="12" /><img src="images/black.png" title="DCR Approve Action" height="12" width="12" /></a>';
						}
						else if(eventd[i].dsr_flag == '0')
						{
							act+='<a href="#"><img src="images/black.png" title="Waiting For DCR Approval" height="12" width="12" /><img src="images/black.png" title="Waiting For DCR Approval" height="12" width="12" /></a>';
						}
					}else if(eventd[i].dsr_status=='Approved')
					{
							act+='<a href="#" onclick="disapproveEventDCRRequest('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +')" ><img src="images/check.jpg" title="DSR Approved" height="12" width="12" /><img src="images/check.jpg" title="DCR Approved" height="12" width="12" /></a>';
				    }
					else if(eventd[i].dsr_status=='Disapproved')
					{
						act+='<a href="#" onclick="disapproveEventDCRRequest('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +')"><img src="images/red.png" title="DCR Disapproved" height="12" width="12" /><img src="images/red.png" title="DCR Disapproved" height="12" width="12" /></a>&nbsp;';
					}
					else if(eventd[i].dsr_status=='No')
					{
						act+='<a href="#" ><img src="images/black.png" title="Waiting For DCR Filling" height="12" width="12" /></a>&nbsp;';
					}

				} 
				else if(eventd[i].status=='Approve')
				{
					if(eventd[i].flag == '0')
					{
						    act+='<a href="#"><img src="images/black.png" title="No Event Approval" height="12" width="12" /></a>';
					}
					else
					{
							act+='<a href="#" onclick="disapproveEventRequest('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +')"><img src="images/black.png" title="Event Action" height="12" width="12" /></a>&nbsp;';	
					}
				}
				else
				{
					act+='<a href="#" onclick="disapproveEventRequest('+date+','+getMonthNumber(monthName)+','+year+','+eventd[i].id +')" ><img title="Event Disapproved" src="images/close.gif"  /></a>&nbsp;&nbsp;&nbsp;';
				}
			}
			act+= '&nbsp;&nbsp;<font size="1">'+eventd[i].Activity+': '+eventd[i].Title+'</font>';
			act+='<br>';
		}
	}
	return act;
}
function disapproveEventRequest(date,month,year,id)
{
	if(month<10)
	{
		month="0"+month;
	...
	$('#abc').dialog('open');
	$('#abc').dialog({title: 'Approve Event on '+date2,height: '450',width:'1250'});
    $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/patientCRMMaster/beforeApproveByManagerAdd.action",
...
function disapproveEventDCRRequest(date,month,year,id)
{
	if(month<10)
	{
		month="0"+month;
	...
	var date=year+'-'+month+'-'+date;
	$('#abc').dialog('open');
	$('#abc').dialog({title: 'Approve DCR on '+date2,height: '450',width:'1250'});
    $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/patientCRMMaster/beforeApproveByManagerDCRAdd.action",
	    data:"id="+id +"&date="+date,
	    success : function(subdeptdata) 
	   {
			$("#"+"activity").html(subdeptdata);
...
function checkHoliday(date,monthName,year)
{
    ...
    {
        var emp=$("#empList").val();
        var subt=$("#empList" +' option:selected').text();
    	$.ajax({
    	    type : "post",
    	    url : "view/Over2Cloud/WFPM/ActivityPlanner/fetchEmpList.action",
    	    async:false,
    	    success : function(subdeptdata) 
    	    {
	    	    if(typeof emp!='undefined')
	    	    {
	    	    	optionsemp+='<option value='+emp+'>'+subt+'</option>';
	    	    }
	    	    else
	    	    {
	    	    	optionsemp+='<option value="-1">Select Employee</option>';
	    	    }
    			for(var i=0;i<subdeptdata.length;i++)
    			{
        			if(emp!=subdeptdata[i].id)
        			{
        				optionsemp+='<option value='+subdeptdata[i].id+'>'+subdeptdata[i].name+'</option>';
        			}
    			}
    	    },
    	    error: function() 
	...
	function drawCal(firstDay, lastDate, date, monthName, year,months) 
	{
		...
		text +=	'<select id="monthVal" style="background-color: white;" onchange="setCalfromdropdown()">'+options+'</select>&nbsp;&nbsp;<select style="background-color: white;" id="yearVal" onchange="setCalfromdropdown()">'+yearList+'</select>&nbsp;&nbsp;<select id="empList" style="background-color: white;" onchange="activityCreate(this.value);">'+optionsemp+'</select></div>'; // close table header's font settings
        text += '<div style="margin-top: -4px;margin-bottom: -19px;margin-right: 225px;"><FONT COLOR="' + headerColor + '" SIZE="3"><b>' ;// set font for table header
		text +=headerName+''+ monthName + ' ' + year ;
		text += '</b></FONT></div>';
		if(headerName=='Self Activity for ')
		{
			text +='<div style="float:right; padding: 0px 17px 0px 0px; "><button id="activity_show" style="width: 114px;" onclick="approveRequest(this.id);">Approval Activity</button> <button id="Event" style="width: 114px; " onclick="approveEventRequest(this.id);">Approval Event</button>';  // close header cell
			text +='<button id="b3" style="width: 114px;" onclick="approvedsrRequest();">DCR Approval</button> <button id="b4" style="width: 114px; " onclick="approveDCRRequest();">Event DCR Approval</button> ';
			text +='</div>';
		}
		else
		{
			text +='<div style="float:right; padding: 0px 17px 0px 0px; "><button id="full_view" style="width: 114px;" onclick="fullViewApproval(this.id);">Approval</button><button id="full_view_dcr" style="width: 114px;" onclick="fullViewApprovalDCR(this.id);">Validate</button>';  // close header cell
			text +='</div>';
		}
		text += '</TD></tr>'; // close header cell
		ab='';
		var openCol = '<TD align='+center+' WIDTH=' + colWidth + ' HEIGHT="5">';
		...
		text += '<TR ALIGN="left" VALIGN="middle" HEIGHT="5">';
		...
		{
			text += '<div style="float:right;margin-top: -17px;">';
	...
	function fullViewApproval(id)
	{
		...
		var val= yr+'-'+month;
	    $('#abc').dialog('open');
    	$('#abc').dialog({title: 'Approve Activity',height: '450',width:'1250'});
        $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
    	$.ajax({
    	    type : "post",
    	    url : "view/Over2Cloud/WFPM/ActivityPlanner/beforeActivityPlannerFullView.action?month="+val+"&emp="+emp,
    	    success : function(subdeptdata) 
    	   {
    			$("#"+"activity").html(subdeptdata);
    	   },
	...
	function fullViewApprovalDCR(id)
	{
		var month=$("#monthVal").val();
		if(month<10)
		{
		...
		var val= yr+'-'+month;
	    $('#abc').dialog('open');
    	$('#abc').dialog({title: 'DCR Approval',height: '450',width:'1250'});
        $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
    	$.ajax({
    	    type : "post",
    	    url : "view/Over2Cloud/WFPM/ActivityPlanner/beforeDSRFillFullView.action?month="+val+"&emp="+emp,
    	    success : function(subdeptdata) 
    	   {
    			$("#"+"activity").html(subdeptdata);
    	   },
	...
	function getReferralAddPage(date,month,year)
	{
        ...
        $('#abc').dialog('open');
    	$('#abc').dialog({title: 'Schedule Activity',height: '450',width:'1250'});
        $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
    	$.ajax({
    	    type : "post",
	...
	function disapproveRequest(date,month,year,id)
	{
		if(month<10)
		{
			month="0"+month;
		...
		var datev=year+'-'+month+'-'+date;
		$('#abc').dialog('open');
		$('#abc').dialog({title: 'Activity Approval',height: '450',width:'1250'});
        $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
    	$.ajax({
    	    type : "post",
	...
	function disapproveDSR(date,month,year,id,id1)
	{
		if(month<10)
		{
			month="0"+month;
		...
		var datev=year+'-'+month+'-'+date;
		$('#abc').dialog('open');
		$('#abc').dialog({title: 'Validate DCR',height: '450',width:'1250'});
        $("#activity").html("<br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
    	$.ajax({
    	    type : "post",
