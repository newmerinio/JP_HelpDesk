...
<script type="text/javascript" src="jqwidgets/jqxchart.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
        	$.ajax({
        	    type : "post",
        	    url : "/over2cloud/view/Over2Cloud/WFPM/Associate/associateDataSource.action",
        	    type : "json",
        	    success : function(data) {
	              ...
	              padding: { left: 0, top: 0, right: 0, bottom: 0 },
                    ...
                    // create the chart
                    $('#chartContainerSource').jqxChart(settings);
...
<body class='default'>
        ...
        <div id='chartContainerSource' style="width: 100%; height: 500px">
        </div>
