...
--><script src="<s:url value="js/userHistory/userActionHistoryView.js"/>"></script>
...
<sj:dialog
   ...
   <div class="clear"></div>
	<div class="list-icon">
	 <div class="head">User Action History</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div> 
</div> 
	<div style=" float:left; padding:10px 1%; width:98%;">
	<div class="listviewBorder">
	 		<div style="" class="listviewButtonLayer" id="listviewButtonLayerDiv">
				<div class="pwie"><table class="lvblayerTable secContentbb" border="0" cellpadding="0" cellspacing="0" 
					width="100%"><tbody><tr></tr><tr><td></td></tr><tr>
					<td> <table class="floatL" border="0" cellpadding="0" 
						...
						<s:select  
							            ...
							            theme               =       "simple"
							      	 	onchange			=		"searchHistoryResult('moduleName',this.value) "
						      	 ...
						      	 >
							        ...
							        cssClass             =      "button"
							        headerKey           =       "-1"
							        headerValue         =       "Select Sub	 Module"
							        cssStyle             =      "margin-top: -29px;margin-left:3px"
							        theme                 =       "simple"
						      	    onchange			=		"searchHistoryResult('sub_module',this.value) "
						      	 >
						      	 </s:select>
						      	  <s:select  
						    		id					=		"userName"
							       ...
							       cssStyle             =      "margin-top: -29px;margin-left:3px"
							      theme                 =       "simple"
						      	 onchange			=		"searchHistoryResult('uah.userName',this.value) "
						      	 >
						      	 </s:select>
