...
function getmoduleName()
{
	...
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/Compliance/compl_contacts_pages/getNameofModuleShare.action?&moduleName="+moduleName,
...
<div class="listviewBorder"  style="margin-top: 10px;width: 97%;margin-left: 20px;" align="center">
	...
	<tr>
	    ...
	    <td class="alignright printTitle">
	      <%if(userRights.contains("sharecon_ADD"))
		   {%>
	        <sj:a id="newSharingButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewSharing('moduleName');">Add</sj:a>
	       <%} %>
	    </td>   
	</tr>
	</tbody>
