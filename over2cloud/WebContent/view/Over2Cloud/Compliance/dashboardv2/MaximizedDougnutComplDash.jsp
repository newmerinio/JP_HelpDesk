...
<center>
	<sjc:chart
        ...
        legendShow="true"
    >
    <s:if test="maximizeDivBlock=='1stDonut'">
    ...
    <s:elseif test="maximizeDivBlock=='2ndDonut'">
    ...
    <s:elseif test="maximizeDivBlock=='3rdDonut'">
    ...
    <s:elseif test="maximizeDivBlock=='4thDonut'">
    ...
    <s:elseif test="maximizeDivBlock=='7thDonut'">
