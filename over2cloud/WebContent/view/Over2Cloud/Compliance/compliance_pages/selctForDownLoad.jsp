...
<s:form action="downloadAction" id="download" theme="css_xhtml">
    ...
    <!--<td>
    	<div class="form_menubox">
    		<div class="user_form_text">Header Name:*</div>
             <div class="user_form_input"><s:textfield name="headerName"/></div>
    	</div>
    	<div class="form_menubox">
    		<div class="user_form_text">Excel Name:*</div>
             <div class="user_form_input"><s:textfield name="excelName" /></div>
    	</div>
    </td>
    --><tr>
    </table>
