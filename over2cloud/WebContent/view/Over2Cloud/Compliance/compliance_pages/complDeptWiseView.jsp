...
function setDownloadType11(type)
{
...
<sj:dialog id="printCompliance" modal="true" effect="slide" autoOpen="false" width="800" height="400" title="Print Compliance" loadingText="Please Wait" overlayColor="#fff" overlayOpacity="1.0" position="['center','top']" >
	<div id="currComplianceDetail"></div>
</sj:dialog>

<div class="container_block"><div style=" float:left; padding:20px 5%; width:90%;">

 <s:url id="dept_View_URL" action="getDeptCompl" />
