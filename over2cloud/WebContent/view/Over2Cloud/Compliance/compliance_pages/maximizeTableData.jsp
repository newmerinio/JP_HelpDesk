...
<center>
	...
	<table border="1" width="100%" align="center">
		<tbody>
		 ...
		 <tr bgcolor="#7D89E3">
			...
			<td  align="center" width="20%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Upcoming</b></font></td>
		...
		<s:iterator id="totalCompl"  status="status" value="%{totalComplDashboard.complList}" >
		 <tr bgcolor="#BABFE0">
			...
			<td align="center" width="20%" onclick="showAllComplDetails('<s:property value="#totalCompl.departId"/>','Upcoming','<s:property value="#totalCompl.compId"/>');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="#totalCompl.UpComing"/></a></font></td>
		...
		<tr bgcolor="#BABFE0">
			...
			<td align="center" width="20%" height="40%" onclick="showAllComplDetails('All','Pending','<s:property value="allCompId1st"/>');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><s:property value="totalUpComing"/></font></td>
	...
	<s:iterator id="lastMonthCompl"  status="status" value="%{previousMonthComplDashboard.complList}" >
	 <tr bgcolor="#EDDFE1">
		...
		<td align="center" width="25%" onclick="lastMonthCompDetail('<s:property value="#lastMonthCompl.departId"/>','Done','Last Month Operational Task','<s:property value="#lastMonthCompl.compId"/>');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="#lastMonthCompl.done"/></a></font></td>
		<td align="center" width="25%" onclick="lastMonthCompDetail('<s:property value="#lastMonthCompl.departId"/>','Pending','Last Month Operational Task','<s:property value="#lastMonthCompl.compId"/>');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;" href="#"><s:property value="#lastMonthCompl.pending"/></a></font></td>
	 </tr>
	</s:iterator>
	
	<tr bgcolor="#EDDFE1">
		<td align="center" width="25%" height="40%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2">Total</font></td>
		<td align="center" width="25%" height="40%" onclick="lastMonthCompDetail('All','Done','Last Month Operational Task','<s:property value="allCompId4th"/>');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="lastMonthDoneTotal"/></a></font></td>
		<td align="center" width="25%" height="40%" onclick="lastMonthCompDetail('All','Pending','Last Month Operational Task','<s:property value="allCompId4th"/>');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="lastMonthPendingTotal"/></a></font></td>
	 </tr>
	</tbody>
	</table>
	</s:elseif>
...
<s:iterator id="levelWiseCompl"  status="status" value="%{escLevelCompDetailObj.complList}" >
 <tr bgcolor="#E2DAE6">
	...
	<td align="center" width="15%" onclick="lastMonthCompDetail('<s:property value="#levelWiseCompl.departId"/>','Level1','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="#levelWiseCompl.esc1Count"/></a></font></td>
	<td align="center" width="15%" onclick="lastMonthCompDetail('<s:property value="#levelWiseCompl.departId"/>','Level2','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;" href="#"><s:property value="#levelWiseCompl.esc2Count"/></a></font></td>
	<td align="center" width="15%" onclick="lastMonthCompDetail('<s:property value="#levelWiseCompl.departId"/>','Level3','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="#levelWiseCompl.esc3Count"/></a></font></td>
	<td align="center" width="15%" onclick="lastMonthCompDetail('<s:property value="#levelWiseCompl.departId"/>','Level4','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;" href="#"><s:property value="#levelWiseCompl.esc4Count"/></a></font></td>
	<td align="center" width="15%" onclick="lastMonthCompDetail('<s:property value="#levelWiseCompl.departId"/>','Level5','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;" href="#"><s:property value="#levelWiseCompl.esc5Count"/></a></font></td>
 </tr>
</s:iterator>

<tr bgcolor="#E2DAE6">
	<td align="center" width="25%" height="40%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2">Total</font></td>
	<td align="center" width="15%" height="40%" onclick="lastMonthCompDetail('All','Level1','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="esc1Total"/></a></font></td>
	<td align="center" width="15%" height="40%" onclick="lastMonthCompDetail('All','Level2','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="esc2Total"/></a></font></td>
	<td align="center" width="15%" height="40%" onclick="lastMonthCompDetail('All','Level3','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="esc3Total"/></a></font></td>
	<td align="center" width="15%" height="40%" onclick="lastMonthCompDetail('All','Level4','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="esc4Total"/></a></font></td>
	<td align="center" width="15%" height="40%" onclick="lastMonthCompDetail('All','Level5','Level wise Operational Task');"><font face="Arial, Helvetica, sans-serif" color="#000000" size="1"><a style="cursor: pointer;text-decoration: none;"  href="#"><s:property value="esc5Total"/></a></font></td>
 </tr>
	</tbody>
	</table>
	</s:elseif>
