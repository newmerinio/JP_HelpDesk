...
<body>
<sj:div   cssClass="result ui-widget-content ui-corner-all" cssStyle="padding:2px 2px 2px 2px">
<center>
	<sjc:chart
        id="%{graphId}"
        cssStyle="width: %{chartWidth}; height: %{chartHeight};"
        pie="true"
        pieLabel="true"
    ...
    >
    <s:if test="maximizeDivBlock=='1stPie'">
    ...
    <s:elseif test="maximizeDivBlock=='2ndPie'">
    ...
    <s:elseif test="maximizeDivBlock=='3rdGraphBlockDiv'">
    ...
    <s:elseif test="maximizeDivBlock=='4thGraphBlockDiv'">
    ...
    <s:elseif test="maximizeDivBlock=='6thGraphBlockDiv'">
     ...
     <s:elseif test="maximizeDivBlock=='7thGraphBlockDiv'">
