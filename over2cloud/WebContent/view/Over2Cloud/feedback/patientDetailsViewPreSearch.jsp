...
function getSearchData()
{
	...
	$.ajax({
 		type :"post",
 		url : "view/Over2Cloud/feedback/beforePatView.action?fromDate="+fromDate+"&toDate="+toDate+"&patType="+patType,
 		success : function(data) 
	    {
			$("#patDetailsDiv").html(data);
		},
	    error: function()
	    {
	        alert("error");
...
<body>
<div class="list-icon">
	 <div class="head">Patient Details</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">View</div> 
</div>
<div class="clear"></div>
...
<s:url id="viewPatients" action="viewPatientsInGrid" >
</s:url>
<div style="overflow: scroll; height: 430px;">
		<div id="patDetailsDiv">
		</div> 	
</div>		
		</div></div>
</body>
