...
<body>
Client Id is as <s:property value="%{clientId}"/>
		      ...
		      <div class="leftColumn1"><s:property value="%{value}"/>&nbsp;:&nbsp;</div>
				<div class="rightColumn1">
	                  ...
	                  <s:select 
	                              ...
	                              cssClass="select"
	                              cssStyle="width:82%"
	                              onchange="commonSelectAjaxCall('feedback_subcategory','id','subCategoryName','categoryName',this.value,'','','subCategoryName','ASC','subCategory3','Select Sub-Category');">
	                  </s:select>
	             </div>
          	...
          	<s:iterator value="feedbackTextColumns" status="status">
          	 <span id="mandatoryFields" class="pIds" style="display: none; "><s:property value="%{key}"/>#Complaint Details#D#,</span>
                 ...
                 <div class="newColumn">
                       ...
                       <div class="rightColumn1"><span class="needed"></span><s:textfield name="%{key}" id="%{key}"maxlength="50"  placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"  cssClass="textField" maxLength="200"/><s:if test="key=='feed_brief'"><div id="errorfeedbrief" class="errordiv"/></s:if></div>
          	    </div>	
          	     </s:if>
          	     <s:else>
          	     <div class="newColumn">
