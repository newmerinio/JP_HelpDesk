...
<s:form action="downloadActivityExcel" id="download" theme="css_xhtml">
	 
	<s:hidden name="fromDate" value="%{fromDate}"/>
<s:hidden name="toDate" value="%{toDate}"/>
<s:hidden name="status" value="%{status}"/>
<s:hidden name="feedBack" value="%{feedBack}"/>
<s:hidden name="mode" value="%{mode}"/>
<s:hidden name="ticket_no" value="%{ticket_no}"/>
<s:hidden name="feedBy" value="%{feedBy}"/>
<s:hidden name="dept" value="%{dept}"/>
<s:hidden name="catg" value="%{catg}"/>
