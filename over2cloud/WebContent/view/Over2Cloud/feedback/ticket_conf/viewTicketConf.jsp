...
function addTicketConfig()
{
	$("#data_part").html("<br><br><br><br><br><br><br><br><br><br><br><br><center><img src=images/ajax-loaderNew.gif></center>");
	$.ajax({
	    type : "post",
	    url : "view/Over2Cloud/feedback/Escalation_Conf/beforeConfigTicket.action",
	    success : function(data) {
       		$("#data_part").html(data);
		},
	    error: function() {
...
<div class="list-icon">
	 <div class="head">
	 Configure Ticket Type</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
	...
	<table class="lvblayerTable secContentbb" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr>
				  ...
				  <sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addTicketConfig();">Add</sj:a>
				  </td>
			</tr>
		</tbody>
	</table>
...
<s:url id="ticketViewConf" action="ticketViewConf">
</s:url>
<s:url id="editDataGrid" action="editTicketViewConf" />
<sjg:grid 
		...
		editable="true"
		edittype="select"
		editoptions="{value:'Manual:Manual;Rating:Rating'}"
		/>
