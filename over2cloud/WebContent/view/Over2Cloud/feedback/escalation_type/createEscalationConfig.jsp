...
<div class="list-icon">
	<div class="head">Escalation Type</div><img alt="" src="images/forward.png" style="margin-top:10px; float: left;"><div class="head">Configure</div>  
...
<s:form id="formone" name="formone" action="addEscalationConfig" theme="simple"  method="post" enctype="multipart/form-data" namespace="/view/Over2Cloud/feedback/Escalation_Conf" >
...
<center><div style="float:center; border-color: black; background-color: rgb(255,99,71); color: white;width: 90%; font-size: small; border: 0px solid red; border-radius: 6px;"><div id="errZone" style="float:center; margin-left: 7px"></div></div></center>  
				...
				<div class="newColumn">
        			   <div class="leftColumn" >Escalation&nbsp;Type:&nbsp;</div>
					        <div class="rightColumn">
				                  <s:select  
				                  		id="openType"
				                        name="openType"
				                        list="#{'Category':'Category','Mode':'Mode'}"
				                        headerKey="-1"
				                        headerValue="Escalation Type" 
				                        cssClass="select"
