...
$.subscribe('getMoreData', function(event,data)
		  {
			  ...
			  $("#gridedittable").jqGrid('setGridParam', {
					url:"view/Over2Cloud/HelpDeskOver2Cloud/Lodge_Feedback/viewFeedbackDetail.action?feedStatus="+feedStatus+"&fromDate="+from_Date+"&toDate="+to_Date+"&dataFlag=M"
					,datatype:'JSON'
					}).trigger("reloadGrid");
		  });
...
<div style="float: right; margin: 0 0px 10px 0;">
 ...
 <div class="clear"></div>
 <div class="border" style="overflow:auto; height:420px;">
...
<s:else>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--<sj:submit value=" More Data " button="true" onClickTopics="getMoreData"/>
--></s:else>
</td></tr></tbody></table>
<td class="alignright printTitle"><sj:a  button="true" cssClass="button" buttonIcon="ui-icon-print" onClickTopics="getFormData">Print</sj:a></td></tr>
