...
function abc()
{
	...
	{
		checkedAll();
		$('#downloadColumnViewAttandance').dialog('close');
	}
	else
	{
...
<body>
<s:form action="downloadActionforAttendanceview" id="download" theme="css_xhtml">
	...
	<s:if test="download4 == 'viewAttendanceMark'">
