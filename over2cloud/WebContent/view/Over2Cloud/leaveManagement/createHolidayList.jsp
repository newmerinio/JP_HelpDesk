...
function resetForm(formId) 
{
 ...
 <div class="border">  
		<s:form id="formone" name="formone" namespace="/view/Over2Cloud/leaveManagement" action="holidayAddAction" theme="simple"  method="post" enctype="multipart/form-data" >
		     	
		    <div style="float:left; border-color: black; background-color: rgb(255,99,71); color: white;width: 100%; font-size: small; border: 0px solid red; border-radius: 6px;">
            <div id="errZone" style="float:left; margin-left: 7px"></div>        
            </div>
            
		     		 <s:iterator value="holidayColumnDate" status="counter" >
		     		   <s:if test="%{mandatory}">
                   ...
                   <div class="newColumn">
                    ...
                    <s:iterator value="holidayColumnText" status="counter">
                      <s:if test="%{mandatory}">
                           <span id="mandatoryFields" class="pIds" style="display: none; "><s:property value="%{key}"/>#<s:property value="%{value}"/>#<s:property value="%{colType}"/>#<s:property value="%{validationType}"/>,</span>
                         </s:if>
                    <s:if test="#counter.count%2 != 0">
                  ...
                  <div class="newColumn">
								...
								<div class="rightColumn1">
                                <s:if test="%{mandatory}"><span class="needed"></span></s:if>
                                <s:textarea id="%{Key}" name="%{Key}" value="%{empmob}" cssStyle="margin:0px 0px 10px 0px"  cssClass="textField" placeholder="Enter Data"  ></s:textarea>
                                </div>
                  </div>                 
                 </s:else>
                 </s:iterator>
		...
		<sj:a cssStyle="margin-left: -1px;margin-top: 0px;" button="true" href="#" onclick="viewHoliday();">Back</sj:a>
