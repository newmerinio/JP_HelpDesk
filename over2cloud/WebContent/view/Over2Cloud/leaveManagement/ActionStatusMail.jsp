    ...
    <p> Just FYI,following action has already been done as</p>
			      ...
			      <table width="40%" align="center" border="0">
                   ...
                   <s:if test="%{key == 'fdate'}">
	                 <tr  style="background-color: #eeeeee" align="center">
								<td>From</td>
								<td> <s:property value="%{fdatetemp}"/>
								<s:hidden name="fdatetemp" value="%{fdatetemp}"></s:hidden>
                  </td>
                   </tr>
                   </s:if>
              </s:iterator>
                  ...
                  <s:if test="%{key == 'tdate'}">
	                 <tr  style="background-color: #eeeeee" align="center">
								<td>To</td>
								<td> <s:property value="%{tdatetemp}"/>
								<s:hidden name="tdatetemp" value="%{tdatetemp}"></s:hidden>
                  </td>
                   </tr>
                   </s:if>
		   ...
		   <s:iterator value="responseColumnText">
				 ...
				 <s:iterator value="responseColumnText">
                  ...
                  <s:iterator value="responseColumnText">
                  <s:if test="%{key == 'approveOn'}">
                  
	               <tr  style="background-color: #eeeeee" align="center">
								<td>Approved On</td>
                  <td> <s:property value="%{approveOnTemp}"/>
                  <s:hidden name="approveOnTemp" value="%{approveOnTemp}"></s:hidden>
                  </td>
                  </tr>
                  </s:if>
                  </s:iterator>
