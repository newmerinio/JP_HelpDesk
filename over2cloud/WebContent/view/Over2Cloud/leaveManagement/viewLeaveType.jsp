...
<!--<%if(userRights.contains("ltype_ADD")){ %>
<div class="rightHeaderButton">
<sj:a  button="true" onclick="addLeaveType();" buttonIcon="ui-icon-plus">Add</sj:a>
</div>
<%} %>
--><%if(userRights.contains("ltype_VIEW")){ %>
 <div style=" float:left; padding:10px 1%; width:98%;">
	...
	<%if(userRights.contains("ltype_MODIFY")){ %>
	...
	<%if(userRights.contains("ltype_ADD")){ %>
<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addLeaveType();">Add</sj:a>
...
<s:url id="leaveTypeview" action="leaveTypeview" escapeAmp="false">
<s:url id="editLeaveTypeData" action="leaveTypeGridDataModify" />
...
<sjg:grid 
		...
		<s:iterator value="leaveTypeGridColomns" id="leaveTypeGridColomns" >  
		<sjg:gridColumn 
		name="%{colomnName}"
		index="%{colomnName}"
		title="%{headingName}"
