...
$.subscribe('level1', function(event,data)
	       {
	         ...
	         setTimeout(function(){ $("#orglevel1Div").fadeOut(); }, 40);
	       });
...
<div class="list-icon">
 ...
 <div class="border">
		<s:form id="formone" name="formone" namespace="/view/Over2Cloud/leaveManagement" action="leaveConfiAdd" theme="simple"  method="post" enctype="multipart/form-data" >
		     	
		    <div style="float:left; border-color: black; background-color: rgb(255,99,71); color: white;width: 100%; font-size: small; border: 0px solid red; border-radius: 6px;">
            <div id="errZone" style="float:left; margin-left: 7px"></div>        
            </div>
		     		 <s:iterator value="confiColumnDropdown" status="counter">
		     		  <s:if test="%{mandatory}">
                  ...
                  <div class="clear"></div>
                    <s:iterator value="confiColumnText">
                     <s:if test="%{mandatory}">
                           <span id="mandatoryFields" class="pIds" style="display: none; "><s:property value="%{key}"/>#<s:property value="%{value}"/>#<s:property value="%{colType}"/>#<s:property value="%{validationType}"/>,</span>
                         </s:if>
                      <s:if test="%{key == 'leaveallo'}">
	                 <div class="newColumn">
								<div class="leftColumn1"><s:property value="%{value}"/>:</div>
								<div class="rightColumn1">
                                <s:if test="%{mandatory}"><span class="needed"></span></s:if>
		...
		<sj:a cssStyle="margin-left: -1px;margin-top: 0px;" button="true" href="#" onclick="viewLeaveConfig();">Back</sj:a>
