...
<body>
<s:form  id="AddAllSingleSpace_Url" action="addAllSingleSpaceForDemo"  theme="css_xhtml">
	 <center>
     ...
     <tr><td bgcolor="#0e0e0e" class="tabular_head" valign="middle" colspan="7">Allot Space For Demo Account</td></tr>
	...
	<tr><td bgcolor="#252525" style=" border-bottom:1px solid #e7e9e9; color:#ffffff;" valign="top" class="tabular_cont">
			<table cellspacing="0" cellpadding="0" width="100%"><tbody>
				<tr>
					...
					<td valign="middle" width="20%">Demo Account Id</td>
	...
	<tr><td bgcolor="#ffffff" style=" border-bottom:1px solid #e7e9e9; color:#181818;" valign="top" class="tabular_cont">
		<table cellspacing="0" cellpadding="0" width="100%"><tbody>
			<tr>
				...
				<td valign="middle" width="2.5%">Client IDS<s:set name="id" value="%{combinekey}" /><input type="checkbox" checked="checked" style="width:20px;"  value="${id}" id="spaceAddress" name="spaceAddress"></td>
