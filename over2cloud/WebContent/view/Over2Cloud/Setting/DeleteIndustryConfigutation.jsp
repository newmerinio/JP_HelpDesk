...
<img src="images/spacer_002.gif" class="refbtn"></td><td class="alignright printTitle"><a href="javascript:;"><img src="images/spacer_002.gif" class="sheetIconN" title="Sheet" border="0" height="26" width="33"></a><a href="javascript:;"><img src="images/spacer_002.gif" class="printIconN" title="Print View" border="0" height="26" width="29"></a></td>   
	...
	<s:url id="ApplicationRemoteUrl" action="industryView"/>
	<s:url id="modifyURLIndustry" action="deleteRecord"></s:url>
	
    <sjg:grid
    	id="gridView1"
    	caption="Industry View Information"
    	dataType="json"
    	href="%{ApplicationRemoteUrl}"
    	pager="true"
    	navigator="true"
    	...
    	rownumbers="true"
    >
    	<sjg:gridColumn name="id" index="id" width="100" title="ID" hidden="false" key="true" sortable="false" align="center"/>
    	<sjg:gridColumn name="name" index="name" width="400" title="Industry Name" editable="true" edittype="text" sortable="true" align="center"/>
    	<sjg:gridColumn name="code" index="code" width="320" title="Industry Code" editable="true" edittype="text"  sortable="true" align="center"/>
    	<sjg:gridColumn name="date" index="date" width="350" title="Date" editable="true" edittype="text" sortable="false" align="center"/>
    </sjg:grid>
</div>
</div>
</div>
