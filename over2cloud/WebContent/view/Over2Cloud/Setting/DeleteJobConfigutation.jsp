...
<input class="btn createNewBtn" value="Add New Job" type="button" onclick="addjob()">
...
<img src="images/spacer_002.gif" class="refbtn"></td><td class="alignright printTitle"><a href="javascript:;"><img src="images/spacer_002.gif" class="sheetIconN" title="Sheet" border="0" height="26" width="33"></a><a href="javascript:;"><img src="images/spacer_002.gif" class="printIconN" title="Print View" border="0" height="26" width="29"></a></td>   
	...
	<s:url id="ApplicationRemoteUrl" action="JobView"/>
	<s:url id="jobmodifyURLIndustry" action="jobdeleteRecord"></s:url>
	
    <sjg:grid
    	id="gridView1"
    	caption="Job View Information"
    	dataType="json"
    	...
    	rownumbers="true"
    >
    	<sjg:gridColumn name="id" index="id" title="ID" width="100" hidden="false" key="true" sortable="false"/>
    	<sjg:gridColumn name="name" index="name" title="Job Name" width="400" editable="true" edittype="text" sortable="true" />
    	<sjg:gridColumn name="code" index="code" title="Job Code" width="320" editable="true" edittype="text"  sortable="true"/>
    	<sjg:gridColumn name="date" index="date" title="Date" width="350" editable="true" edittype="text" sortable="false"/>
    </sjg:grid>
</div>
</div>
</div>
