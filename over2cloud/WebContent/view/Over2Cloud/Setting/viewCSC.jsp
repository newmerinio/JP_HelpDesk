...
Chunk Space Registration</div></div>
...
<input class="btn createNewBtn" value="Add New Server" type="button" onclick="chunkDbAdd()">
...
<img src="images/spacer_002.gif" class="refbtn"></td><td class="alignright printTitle"><a href="javascript:;"><img src="images/spacer_002.gif" class="sheetIconN" title="Sheet" border="0" height="26" width="33"></a><a href="javascript:;"><img src="images/spacer_002.gif" class="printIconN" title="Print View" border="0" height="26" width="29"></a></td>   
	...
	<s:url id="remoteurl" action="viewCSCGrid.action"/>
	<s:url id="modifyURL" action="modifyCSCGrid.action"/>
    ...
    >
    	...
    	<sjg:gridColumn name="dbname" index="dbname" title="DB Name" editable="true" edittype="text" sortable="false"/>
    	<sjg:gridColumn name="dbusername" index="dbusername" title="DB Username" width="150" editable="true" edittype="text" sortable="true"/>
    	<sjg:gridColumn name="dbpassword" index="dbpassword" title="DB Password" width="150" editable="true" edittype="text" />
    	<sjg:gridColumn name="datetime" index="datetime" title="Date/Time" width="200"/>
    	<sjg:gridColumn name="isoCountrycode" index="isoCountrycode" title="ISO Country Code"  editable="false" edittype="text" />
    	<sjg:gridColumn name="status" index="status" title="Status" hidden="true" />
