...
<s:url  id="contextz" value="/template/theme" />
	...
	$("#addingDocumnetPage").click(function(){
		$("#data_part").html("<br><br><center><img src=images/ajax-loaderNew.gif style='margin-top: 15%;'></center>");
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/AssetOver2Cloud/Help_Doc/uploadaddpage.action?modifyFlag=0&deleteFlag=0",
...
<body>
	...
	<div style="" class="listviewButtonLayer" id="listviewButtonLayerDiv">
			...
			<span class="normalDropDown">
					     ...
					     <sj:a button="true" cssClass="button" cssStyle="height:25px;" title="Add" buttonIcon="ui-icon-plus" id="addingDocumnetPage">Add</sj:a>
			</td>   
			</tr></tbody></table></div>	</div>
			<div class="clear"></div>
		<s:url id="uploaddocumentview" action="uploaddocumentview"></s:url>
		<s:url id="modifyuploadgrid" action="modifyuploadgrid" />
		<div style="overflow: scroll; height: 480px;">
		<sjg:grid 
			  id="idseriesViewid"
	          href="%{uploaddocumentview}"
	          ...
	          >
		<s:iterator value="viewdocumentuploadcolumn" id="viewdocumentuploadcolumn" >  
		<sjg:gridColumn 
			name="%{colomnName}"
			index="%{colomnName}"
			title="%{headingName}"
