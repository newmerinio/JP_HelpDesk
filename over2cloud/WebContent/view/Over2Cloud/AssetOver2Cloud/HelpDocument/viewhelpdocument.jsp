...
<s:url  id="contextz" value="/template/theme" />
	...
	function editRow()
	{
		...
		jQuery("#idseriesViewid").jqGrid('editGridRow', row ,{width:425,reloadAfterSubmit:true,closeAfterEdit:true,top:0,left:350,modal:true});
	}
	...
	function deleteRow()
	{
		...
		$("#idseriesViewid").jqGrid('delGridRow',row, {height:120,reloadAfterSubmit:false,top:0,left:350,modal:true});
	}
	function searchRow()
	{
		jQuery("#idseriesViewid").jqGrid('searchGrid', {multipleSearch:false,reloadAfterSubmit:true,top:0,left:350,modal:true} );
	}
	function refreshRow(row, result) 
	{
		  $("#idseriesViewid").trigger("reloadGrid"); 
	}



	$("#addLinkMapping").click(function(){
		$("#data_part").html("<br><br><center><img src=images/ajax-loaderNew.gif style='margin-top: 15%;'></center>");
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/AssetOver2Cloud/Help_Doc/linkMappingadd.action?modifyFlag=0&deleteFlag=0",
...
<title>Help Document Mappingt</title>
</head>
<body>
	<div class="list-icon">
	...
	<div style="" class="listviewButtonLayer" id="listviewButtonLayerDiv">
			...
			<span class="normalDropDown">
					     ...
					     <sj:a button="true" cssClass="button" cssStyle="height:25px;" title="Add" buttonIcon="ui-icon-plus" id="addLinkMapping">Add</sj:a>
			</td>   
			</tr></tbody></table></div>	</div>
			<div class="clear"></div>
		<s:url id="moduleLinkingMapping" action="moduleLinkingMapping"></s:url>
		<s:url id="modifyhelpdocument" action="modifyhelpdocument" />
		<div style="overflow: scroll; height: 480px;">
		<sjg:grid 
			  id="idseriesViewid"
	          href="%{moduleLinkingMapping}"
	          gridModel="idseriesData"
	          navigator="true"
	          navigatorAdd="false"
	          navigatorView="true"
	          ...
	          >
		<s:iterator value="viewidseriescolumn" id="viewidseriescolumn" >  
		<sjg:gridColumn 
			name="%{colomnName}"
			index="%{colomnName}"
			title="%{headingName}"
