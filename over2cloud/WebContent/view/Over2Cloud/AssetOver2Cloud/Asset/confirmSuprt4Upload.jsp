...
<body>
<div id="suprtExcelResult">
<s:hidden id="uploadModule" value="%{upload4}" />
<s:url id="viewUploadExcelDataSuprt" action="viewUploadExcelGridData">
</s:url>
<sjg:grid 
		  id="uploadDataGridSuprt"
          caption="Upload Data"
          href="%{viewUploadExcelDataSuprt}"
