...
function fillAlphabeticalLinks()
{
	...
	for(var i=65; i<=90; i++)
	{
		val += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="searchResult(\'vendorname\',\''
...
<div class="list-icon">
	 <div class="head">
	 Vendor</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
	...
	<table class="lvblayerTable secContentbb" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr>
				  <td>
					  <table class="floatL" border="0" cellpadding="0" cellspacing="0">
					    <tbody><tr><td class="pL10">   
					     	<%if(userRights.contains("veor_MODIFY")) {%>
							...
							<%} %>
							<%if(userRights.contains("veor_DELETE")) {%>
				  ...
				  <sj:a  button="true" cssClass="button" cssStyle="height:25px; width:32px"  title="Download"  buttonIcon="ui-icon-arrowstop-1-s" onclick="getCurrentColumn('downloadExcel','venderDetail','downloadColumnAllModDialog','downloadAllModColumnDiv');" />
				    <%if(userRights.contains("veor_ADD")) {%>
							<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewEntry('Vendor');">Add</sj:a>
	     			<%}%>
				  </td>
			</tr>
		</tbody>
...
<s:url id="modifyVendor" action="modifyVendorGrid" />
<s:url id="vewiVendor" action="viewVendorGrid" escapeAmp="false">
...
<sjg:grid 
		...
		<s:if test="colomnName=='contactperson' || colomnName=='emailid' || colomnName=='contactno'"> 
			<sjg:gridColumn 
			name="%{colomnName}"
			index="%{colomnName}"
			title="%{headingName}"
