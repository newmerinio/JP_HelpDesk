...
<div class="list-icon">
	 <div class="head">
	 Vendor Type</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
		...
		<tbody>
			<tr>
				  <td>
					  <table class="floatL" border="0" cellpadding="0" cellspacing="0">
					    <tbody><tr><td class="pL10">   
					     	<%if(userRights.contains("vety_MODIFY")) {%>
							...
							<%} %>
							<%if(userRights.contains("vety_DELETE")) {%>
				  ...
				  <td class="alignright printTitle">
				     <%if(userRights.contains("vety_ADD")) {%>
							<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewEntry('VendorType');">Add</sj:a>
	      			<%}%>
				  </td>
			</tr>
		</tbody>
...
<s:url id="modifyVendorType" action="modifyVendorTypeGrid" />
<s:url id="viewVendorType" action="viewVendorTypeGrid" />
<sjg:grid 
