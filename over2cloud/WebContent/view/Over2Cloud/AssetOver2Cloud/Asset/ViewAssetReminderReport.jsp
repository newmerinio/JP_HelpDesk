...
function docDownloadAction(remiderId) 
{
	$.ajax({
	    type : "post",
	    url : "/over2cloud/view/Over2Cloud/AssetOver2Cloud/Asset/remiderDocDownloadAction.action?remiderReportId="+remiderId,
...
function getData(valueFor)
{
	...
	$.ajax({
 		type :"post",
 		url :"/over2cloud/view/Over2Cloud/AssetOver2Cloud/Asset/getOnloadData.action?fromDate="+fromDate+"&toDate="+toDate+"&actionStatus="+actionStatus+"&searchPeriodOn="+periodSort+"&outletId="+outletId+"&frequency="+freque,
 		success : function(data) 
	    {
...
<div class="list-icon">
	 <div class="head">
	 Reminder</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
	...
	<div class="pwie">
		...
		<td class="pL10"> 
	      ...
	      <s:select  
		   ...
		   <sj:a  button="true" cssClass="button" cssStyle="height: 27px;margin-left: 4px;" onclick="getSearchData('fromDate','toDate','outletId','actionStatus','periodSort','frequency');">OK</sj:a>
		</tr>
		</tbody>
		</table>
