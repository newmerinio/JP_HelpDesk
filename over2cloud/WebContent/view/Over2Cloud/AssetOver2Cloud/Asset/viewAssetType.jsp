...
<div class="list-icon">
	 <div class="head">
	 Asset Type</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
		...
		<tbody>
			<tr>
				  <td>
					  <table class="floatL" border="0" cellpadding="0" cellspacing="0">
					    <tbody><tr><td class="pL10">   
					     	<%if(userRights.contains("aspe_MODIFY")) {%>
							...
							<%} %>
							<%if(userRights.contains("aspe_DELETE")) {%>
				  ...
				  <td class="alignright printTitle">
				     <%if(userRights.contains("aspe_ADD")) {%>
							<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewEntry('assetType');">Add</sj:a>
	      			<%}%>
				  </td>
			</tr>
		</tbody>
...
<s:url id="modifyAssetType" action="modifyAssetTypeGrid" />
<s:url id="viewAssetType" action="viewAssetTypeGrid" />
<sjg:grid 
