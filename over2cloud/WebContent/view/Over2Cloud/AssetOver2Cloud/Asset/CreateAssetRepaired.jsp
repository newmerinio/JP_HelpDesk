...
<body>
	<div class="list-icon">
	<div class="head">Asset >> Repaired Detail</div>
</div>
<div style=" float:left; width:100%; height: 350px;">
<div class="border">
   <s:form id="formone" name="formone" namespace="/view/Over2Cloud/AssetOver2Cloud/Asset" action="assetRepairedAction" theme="css_xhtml"  method="post"enctype="multipart/form-data" >
			<center>
            ...
            <div id="errZone" style="float:center; margin-left: 7px"></div>        
	 		...
	 		<s:hidden name="assetRepairedStatus" value="1" />
			        ...
			        <sj:submit 
			          ...
			          <sj:a 
				     	href="#" 
		               	button="true" 
		               	onclick="viewPage();"
						cssStyle="margin-left: 200px;margin-top: -28px;"
						>
					  	Cancel
						</sj:a>
				    </div>
