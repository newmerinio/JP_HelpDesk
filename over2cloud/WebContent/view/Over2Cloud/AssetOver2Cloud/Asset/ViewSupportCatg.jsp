		...
		<tbody>
			<tr>
				  <td>
					  <table class="floatL" border="0" cellpadding="0" cellspacing="0">
					    <tbody><tr><td class="pL10">   
					     	<%if(userRights.contains("suty_MODIFY")) {%>
							...
							<%} %>
							<%if(userRights.contains("suty_DELETE")) {%>
				  ...
				  <td class="alignright printTitle">
				     <%if(userRights.contains("suty_ADD")) {%>
							<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewEntry('AssetSuprtCatg');">Add</sj:a>
	      			<%}%>
				  </td>
			</tr>
		</tbody>
...
<s:url id="modifySupportCatg" action="modifySupportCatgGrid" />
<s:url id="viewSupportCatg" action="viewSupportCatgGrid" />
<sjg:grid 
		 
          id="gridedittable"
          href="%{viewSupportCatg}"
