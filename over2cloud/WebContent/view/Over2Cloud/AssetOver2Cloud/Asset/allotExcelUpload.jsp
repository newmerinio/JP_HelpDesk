...
<div class="middle-content">
	<div class="list-icon">
	<div class="head">Asset Allotment >> Excel Upload</div>
</div>
...
<sj:accordionItem title="Asset Allotment >> Excel Upload" id="twoId">
<s:form id="formtwo" action="uploadExcel" theme="css_xhtml" method="post" enctype="multipart/form-data">
			<s:hidden name="upload4" value="allotmentDetail" />
			<div class="form_menubox">
       		...
       		<a id='astAllotUpload' onclick="getCurrentColumn('uploadExcel','totalAllotDetail','uploadColumnAllotDialog','uploadAllotColumnDiv')">
        	...
        	<sj:submit
                  openDialog="AssetAllotmentDialog"
                  value=" Upload "
                  targets="createAllotBasic"
                  clearForm="true"
                  button="true"
        	...
        	<sj:dialog
                  id="AssetAllotmentDialog"
                  autoOpen="false"
                  closeOnEscape="true"
                  modal="true"
                  title="Assets Allotment Detail Upload Via Excel"
                  width="600"
                  height="350"
                  showEffect="slide"
                  hideEffect="explode">
...
<sj:dialog id="uploadColumnAllotDialog" modal="true" effect="slide" autoOpen="false" width="300" height="500" title="Asset Detail Column Name" loadingText="Please Wait" overlayColor="#fff" overlayOpacity="1.0" position="['left','top']" >
	<div id="uploadAllotColumnDiv"></div>
</sj:dialog>
</html>