...
function fillAlphabeticalLinks()
{
	...
	for(var i=65; i<=90; i++)
	{
		val += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="searchResult(\'spare_name\',\''
		...
		<tbody>
			<tr>
				  ...
				  <td class="alignright printTitle">
				   <sj:a  button="true" cssClass="button" cssStyle="height:25px; width:32px"  title="Download"  buttonIcon="ui-icon-arrowstop-1-s" onclick="getCurrentColumn('downloadExcel','totalSpareDetail','downloadColumnAllModDialog','downloadAllModColumnDiv');" />
				     <%if(userRights.contains("spde_ADD")) {%>
							<sj:a id="addButton"  button="true"  buttonIcon="ui-icon-plus" cssClass="button" onclick="addNewEntry('SpareDetails');">Add</sj:a>
	      			<%}%>
				  </td>
			</tr>
		</tbody>
...
<s:url id="modifySpare" action="modifySpareAction"/>
<s:url id="viewSpare" action="viewSpareAction" escapeAmp="false">
