...
<div class="list-icon">
	 <div class="head">
	 Receiving Spare</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div>
	...
	<table class="lvblayerTable secContentbb" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr>
				  <td>
					  <table class="floatL" border="0" cellpadding="0" cellspacing="0">
					    <tbody><tr><td class="pL10">   
					     	<%if(userRights.contains("resp_MODIFY")) {%>
							...
							<%} %>
							<%if(userRights.contains("resp_DELETE")) {%>
				  ...
				  <sj:a  button="true" cssClass="button" cssStyle="height:25px; width:32px"  title="Download"  buttonIcon="ui-icon-arrowstop-1-s" onclick="getCurrentColumn('downloadExcel','totalRecvSpareDetail','downloadColumnAllModDialog','downloadAllModColumnDiv');" />
				      <%if(userRights.contains("resp_ADD")) {%>
...
<s:url id="modifyReceiveSpare111" action="modifyReceiveSpare" />
<s:url id="viewReceiveSpare" action="viewReceiveSpareGridData" escapeAmp="false">
