...
function totalDataFunction(value)
{
	...
	else
	{
		...
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Analytical_Report/getProductivityData.action?id="+value+"&fromDate="+fromDate+"&toDate="+toDate+"&deptId="+deptId+"&subdeptId="+subdeptId+"&byDeptId="+byDept+"&dataFor=Category&moduleName=HDM",
...
function onTimeDataFunction(value)
{
	...
	else 
	{
		...
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Analytical_Report/getProductivityData.action?id="+value+"&fromDate="+fromDate+"&toDate="+toDate+"&deptId="+deptId+"&subdeptId="+subdeptId+"&byDeptId="+byDept+"&dataFor=Category&moduleName=HDM&searchField=OnTime",
		    success : function(data) 
		    {
	       		$("#dialogOpen").html(data);
		    },
...
function offTimeDataFunction(value)
{
	...
	else 
	{
		...
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Analytical_Report/getProductivityData.action?id="+value+"&fromDate="+fromDate+"&toDate="+toDate+"&deptId="+deptId+"&subdeptId="+subdeptId+"&byDeptId="+byDept+"&dataFor=Category&moduleName=HDM&searchField=Offtime",
		    success : function(data) 
		    {
	       		$("#dialogOpen").html(data);
		    },
...
function missedDataFunction(value)
{
	...
	else 
	{
		...
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Analytical_Report/getProductivityData.action?id="+value+"&fromDate="+fromDate+"&toDate="+toDate+"&deptId="+deptId+"&subdeptId="+subdeptId+"&byDeptId="+byDept+"&dataFor=Category&moduleName=HDM&searchField=Missed",
		    success : function(data) 
		    {
	       		$("#dialogOpen").html(data);
		    },
...
function snoozeDataFunction(value)
{
	...
	else 
	{
		...
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Analytical_Report/getProductivityData.action?id="+value+"&fromDate="+fromDate+"&toDate="+toDate+"&deptId="+deptId+"&subdeptId="+subdeptId+"&byDeptId="+byDept+"&dataFor=Category&moduleName=HDM&searchField=Snooze",
		    success : function(data) 
		    {
	       		$("#dialogOpen").html(data);
		    },
...
function ignoreDataFunction(value)
{
	...
	else 
	{
		...
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/HelpDeskOver2Cloud/Analytical_Report/getProductivityData.action?id="+value+"&fromDate="+fromDate+"&toDate="+toDate+"&deptId="+deptId+"&subdeptId="+subdeptId+"&byDeptId="+byDept+"&dataFor=Category&moduleName=HDM&searchField=Ignore",
		    success : function(data) 
		    {
	       		$("#dialogOpen").html(data);
		    },
