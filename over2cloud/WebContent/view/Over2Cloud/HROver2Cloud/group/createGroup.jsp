   ...
   <s:form id="formone" name="formone" namespace="/view/Over2Cloud/hr" action="addGroup" theme="css_xhtml"  method="post"enctype="multipart/form-data" >
          <center>
            ...
            <div id="errZone" style="float:center; margin-left: 7px"></div>        
                 ...
                 <s:if test="%{mgtStatus}">
                   <span class="pIds" style="display: none; ">countryOffc#Country Office#D#,</span>
                 <div class="newColumn">
			        ...
			        <s:else>
			        <s:hidden name="mapped_level" id="regLevel" value="%{regLevel}"/>
			        </s:else>
                 <s:iterator value="groupTextBox" status="counter">
                  ...
                  <div class="newColumn">
                              ...
                              <s:textfield name="%{key}" id="%{key}" maxlength="200"  onchange="checkContactType(this.value);" maxLength="%{field_length}" placeholder="Enter Data" cssStyle="margin:0px 0px 10px 0px"  cssClass="textField"/>                
