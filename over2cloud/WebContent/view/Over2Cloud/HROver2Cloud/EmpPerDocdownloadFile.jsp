...
<body>
<s:url id="fileDownload" action="downloadEmpPerDetails" ></s:url>
...
<s:if test="%{empPersonalFullViewMap != null && empPersonalFullViewMap.size > 0}">
	<table width="100%">
	<tr style="background-color: #66CCFF"><td colspan="4" align="Center"><STRONG>Personal Details</STRONG>
	<s:iterator value="%{empPersonalFullViewMap}">
		<tr  style="background-color: #C2EBFF">
		<td>
		<s:property value="%{value}"/> &nbsp;&nbsp;
		<a href="<%=request.getContextPath()%>/view/Over2Cloud/hr/downloadEmpPerDetails.action?fileName=<s:property value="%{value}"/>">
