...
<script type="text/javascript">
	...
	<div class="listviewBorder">
			...
			<span class="normalDropDown">
					     ...
					     <sj:a button="true" cssClass="button" cssStyle="height:25px;" title="Back" buttonIcon="" id="cancelVisitorINId">Back</sj:a>
			</td>   
			</tr></tbody></table></div>	</div>
			<div class="clear"></div>
		<s:url id="visitorINView" action="visitorINView"></s:url>
		<s:url id="modifyVisitorIN" action="modifyVisitorIN" />
		<div style="overflow: scroll; height: 480px;">
		<sjg:grid 
			  id="vistormovementviewid"
	          href="%{visitorINView}"
	          gridModel="visitorInData"
	          navigator="true"
	          navigatorAdd="false"
	          navigatorView="true"
		...
		<s:iterator value="viewVisitorInDetail" id="viewVisitorInDetail" >  
		<sjg:gridColumn 
			name="%{colomnName}"
			index="%{colomnName}"
			title="%{headingName}"
