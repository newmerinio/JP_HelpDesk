...
<script type="text/javascript">
		       ...
		       {
		         setTimeout(function(){ $("#vendorentryaddition").fadeIn(); }, 10);
		         setTimeout(function(){ $("#vendorentryaddition").fadeOut(); }, 4000);
		       });
	</script>
	<script type="text/javascript">
...
<body>
	<div class="list-icon">
	 <div class="head">Vendor Type</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">Add</div>
	</div>
<div class="clear"></div>
	...
	<s:form id="formone" name="formone" namespace="/view/Over2Cloud/VAM/master" action="vendorSubmit" theme="css_xhtml"  method="post" >
	        ...
	        <div class="clear"></div>
	<!-- Text box -->
					<s:iterator value="vendorfields" status="counter">
					<s:if test="%{mandatory}">
	        ...
	        <sj:submit 
	         ...
	         <sj:a 
	          ...
	          <sj:a 
					...
					<sj:div id="vendorentryaddition"  effect="fold">
					 <div id="vendoraddresult"></div>
					</sj:div>
			</div>
	   		</center>
	</s:form>
