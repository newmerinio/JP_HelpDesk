...
<s:bean name="com.Over2Cloud.ctrl.VAM.download.VisitorCommonPropertyMap" var="propertyMap">
...
<s:hidden name="from_date" value="%{#parameters.from_date}"/>
<s:hidden name="to_date" value="%{#parameters.to_date}"/>
