...
<head>
		...
		<script type="text/javascript">
			$.subscribe('presult', function(event,data)
			       {
			         setTimeout(function(){ $("#visitorexit").fadeIn(); }, 10);
			         setTimeout(function(){ $("#visitorexit").fadeOut(); }, 4000);
	...
	<script type="text/javascript">
		function exitVisitor()
		{
			...
			$.ajax({
			type:"post",
			// url: "view/Over2Cloud/VAM/master/exitVisitor.action?sr_number="+srnumber+"&cardnumber="+cardnumber+"&barcode="+barcode,
			url: "view/Over2Cloud/VAM/master/exitdashVisitor.action?sr_number="+srnumber+"&barcode="+barcode,
			success : function(visitorexitdata) {
			       $("#"+"visitorexitdashboard").html(visitorexitdata);
				},
				   error: function() {
			            alert("error");
			        }
...
<body>
	<div class="list-icon">
		<div class="head">Visitor</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">Exit</div>
	</div>
	<div class="clear"></div>
