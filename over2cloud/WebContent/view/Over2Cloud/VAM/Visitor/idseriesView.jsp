...
<body>
	...
	<div style="" class="listviewButtonLayer" id="listviewButtonLayerDiv">
			...
			<span class="normalDropDown">
					     ...
					     <sj:a button="true" cssClass="button" cssStyle="height:25px;" title="Add" buttonIcon="ui-icon-plus" id="addidseriesId">Add</sj:a>
			</td>   
			</tr></tbody></table></div>	</div>
			<div class="clear"></div>
		<s:url id="idseriesviewID" action="idseriesview"></s:url>
		<s:url id="modifyidseriesGridId" action="modifyidseriesGrid" />
