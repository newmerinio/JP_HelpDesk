...
<head>
	...
	<script type="text/javascript">
		function exitVisitor()
		{
			...
			url: "view/Over2Cloud/VAM/master/exitVisitor.action?sr_number="+srnumber+"&barcode="+barcode,
			success : function(visitorexitdata) {
			       $("#"+"visitorexit").html(visitorexitdata);
				},
				   error: function() {
			            alert("error");
			        }
...
<body>
	<div class="list-icon">
		<div class="head">Visitor</div><div class="head"><img alt="" src="images/forward.png" style="margin-top:50%; float: left;"></div><div class="head">Exit</div>DDDDDDDDDDDD
	</div>
	<div class="clear"></div>
