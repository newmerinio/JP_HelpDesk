...
function showDetailsData(div)
{
	...
	function stillInVisitor()
	{
					$.ajax({
					    type : "post",
					    url : "view/Over2Cloud/VAM/master/beforedashboardvisitorview.action?modifyFlag=0&deleteFlag=0",
					    success : function(subdeptdata) {
...
<script type="text/javascript">
	function showPieChart(id)
	{
		...
		$.ajax( {
			type :"post",
			url : "view/Over2Cloud/VAM/master/pieChartDeptwiseReport.action",
	...
	else if(id=='fourthblockId')
	{
		...
		$.ajax( {
			type :"post",
			url : "view/Over2Cloud/VAM/master/pieChartPurposewiseReport.action",
			success : function(visitordata) {
...
function showCounterDataDashboardTable(id)
{
	...
	$.ajax( {
		type :"post",
		url : "view/Over2Cloud/VAM/master/tableDeptwiseVisitorReport.action",
...
else if(id=='fourthblockId')
	{
		...
		$.ajax( {
			type :"post",
			url : "view/Over2Cloud/VAM/master/tablePurposewiseVisitorReport.action",
			success : function(deptdashdata) {
...
<div style="height:auto; margin-bottom:10px;" ><B>Departmentwise Visitor Status</B></div>
                   ...
                   <td valign="top" style="padding-top: 5px" align="center">
					   ...
					   <table align="center" border="0" width="100%" style="border-style:dotted solid;" >                        		
                             <s:iterator id="listOlists"  value="listOlists" var = "childlist"> 
                        		...
                        		<td align="left" width="12%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2"><a style="cursor: pointer;text-decoration: none;" href="#"><b><s:property value="%{#childlist[0]}"/> </b></a></font></td>
                                <td align="left" width="12%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2"><a style="cursor: pointer;text-decoration: none;" href="#"><b><s:property value="%{#childlist[1]}"/> </b></a></font></td>
                                <td align="left" width="12%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2"><a style="cursor: pointer;text-decoration: none;" href="#"><b><s:property value="%{#childlist[2]}"/> </b></a></font></td>
                                <td align="left" width="12%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2"><a style="cursor: pointer;text-decoration: none;" href="#"><b><s:property value="%{#childlist[3]}"/> </b></a></font></td>
                                </tr>
                        	   </s:iterator>
                        </table>
...
<!-- Visitor count start here -->
<div class="contentdiv-small" style="overflow: hidden;">
<div class="clear"></div>
<div style="height:auto; margin-bottom:10px;" id='1stBlock'>
<div style="height:auto; margin-bottom:10px;" ><B>Visitor Count</B></div>
<table  align="center" border="0" width="100%" style="border-style:dotted solid;">
<tbody>
