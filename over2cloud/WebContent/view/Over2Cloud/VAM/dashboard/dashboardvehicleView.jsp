<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    >
		...
		<div style="height:auto; margin-bottom:10px;" ><B>Current Vehicle In Campus</B></div>
				  ...
				  <tr>
	                   <td valign="bottom">
	                       <table align="center" border="1" style="border-style:dotted solid;" width="100%">
	                        	  <tr bgcolor="#808000">
	                        	  		<td align="center" width="6%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Sr No</b></font></td>
	                        			<td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Driver Name</b></font></td>
		                                <td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Driver Mobile</b></font></td>
		                                <td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Vehicle No</b></font></td>
		                                <td align="center" width="10%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Material Details</b></font></td>
		                                <td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Quantity</b></font></td>
		                                <td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>For Department</b></font></td>
	                        	        <td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Location</b></font></td>
		                                <td align="center" width="12%" height="70%"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><b>Destination</b></font></td>
                   ...
                   <td valign="top" style="padding-top: 5px" align="center">
                       ...
                       <table align="center" border="0" style="border-style:dotted solid;" width="100%">
                        	  ...
                        	  <s:iterator id="dashboardvisitorData"  value="dashboardvisitorData" var = "varvisitorlist"> 
                        	    ...
                        	    <td align="center" id="testid" width="6%"><font face="Arial, Helvetica, sans-serif" color="#000000" size="2"><a style="cursor: pointer;text-decoration: none;" id="srnumberid" href="#" onclick="exitDashboardVisitor();"><b><s:property value="%{value}"/> </b></a></font></td>
                        	    </s:if>
                        	    <s:else>
