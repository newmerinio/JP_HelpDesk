...
<script src="<s:url value="/js/buddy/buddyvalidation.js"/>"></script>
		    ...
		    <sj:accordionItem title="Buddy >> Add Sub-Floors" onclick="getFloorInfo('testDiv');">
			  <s:form id="formone1" name="formone1" namespace="/view/Over2Cloud/BuddyOver2Cloud/BuddySetting" action="buddyAddSubFloor" theme="css_xhtml"  method="post"enctype="multipart/form-data" >
   			    <s:hidden name="deptHierarchy" id="deptHierarchy" value="%{deptHierarchy}"></s:hidden>
                    ...
                    <s:iterator value="buddyDropDowmColumnMap" status="counter">
                          <s:if test="%{mandatory}">
                            <span id="mandatoryFields" class="pIdsss" style="display: none; "><s:property value="%{key}"/>#<s:property value="%{value}"/>#<s:property value="%{colType}"/>#<s:property value="%{validationType}"/>,</span>
                         </s:if>
                       <s:if test="%{mandatory}">
                                <div class="newColumn">
								<div class="leftColumn1"><s:property value="%{value}"/>:</div>
              ...
              <div class="clear"></div>
               <s:iterator value="buddyFloorColumnMap" begin="5">
	  			 	  <s:if test="%{mandatory}">
               		  <span id="normal" class="pIdsss" style="display: none; "><s:property value="%{key}"/>#<s:property value="%{value}"/>#<s:property value="%{colType}"/>#<s:property value="%{validationType}"/>,</span>
                      </s:if>
	  			 	  <div class="newColumn">
								<div class="leftColumn1"><s:property value="%{value}"/>:</div>
								<div class="rightColumn1">
