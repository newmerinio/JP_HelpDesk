...
<s:hidden name="deptHierarchy" id="deptHierarchy" value="%{deptHierarchy}"></s:hidden>
        			   ...
        			   <div class="leftColumn" ><s:property value="%{value}"/>:</div>
					        <div class="rightColumn">
					             ...
					             <s:select 
				                              id="%{key}"
				                              name="%{key}"
				                              list="#{'Resolved': 'Resolved','Pending': 'Pending', 'Snooze' : 'Snooze', 'High Priority': 'High Priority', 'Ignore': 'Ignore'}"
				                              headerKey="All"
				                              headerValue="All" 
				                              cssClass="select"
					                          cssStyle="width:82%">
    ...
    <div class="clear"></div>
           ...
           <s:if test="%{pageType!='H'.toString()}" >
            <center><b>Note : You can get data here after 15th July 2014!!!</b></center>
           </s:if>
     </s:form>
</div>
</div>
