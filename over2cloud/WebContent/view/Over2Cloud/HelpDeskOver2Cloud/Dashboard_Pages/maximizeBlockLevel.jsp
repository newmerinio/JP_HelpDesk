...
<div id='levelChart2' style="width: 100%; height: 200px" align="center"></div>
</s:elseif>

<s:elseif test="maximizeDivBlock=='level_LineChart'">
<div id='levelChart3' style="width: 100%; height: 200px" align="center"></div>
</s:elseif>

<s:elseif test="maximizeDivBlock=='level_BubbleChart'">
<div id='levelChart4' style="width: 100%; height: 200px" align="center"></div>
</s:elseif>

<s:elseif test="maximizeDivBlock=='level_PiePendingChart'">
<div id='levelChart5' style="width: 100%; height: 300px" align="center"></div>
</s:elseif>
