...
<center><div style="float:center; border-color: black; background-color: rgb(255,99,71); color: white;width: 100%; font-size: small; border: 0px solid red; border-radius: 6px;"><div id="errZoneformthree" style="float:center; margin-left: 7px"></div></div></center>	
                   ...
                   <div class="newColumn">
        			   <div class="leftColumn" ><s:property value="%{value}"/>:</div>
					        <div class="rightColumn">
				                 ...
				                 <s:textfield name="deptName" readonly="true" id="deptName3" value="%{deptName}" cssClass="textField"/>
                           </div>
                   </div>
	          </s:if>
              <s:else>
					      ...
					      <div class="leftColumn"><s:property value="%{value}"/>:</div>
							<div class="rightColumn">
				                  ...
				                  <s:select 
				                              ...
				                              cssClass="select"
				                              cssStyle="width:82%"
				                              onchange="getFeedType4Download(this.value,'feedTypeDiv3');"
				                              onchange="commonSelectAjaxCall2('feedback_type','id','fbType','dept_subdept',this.value,'moduleName','HDM','fbType','ASC','fbType3','Select Feedback Type');"
				                              >
				                  </s:select>
				           </div>
	                  </div>
	   ...
	   <s:iterator value="pageFieldsColumns" status="status" begin="3" end="4"> 
	   <s:if test="#status.odd">
	     <div class="newColumn">
			 <div class="leftColumn" ><s:property value="%{value}"/>:</div>
			 <div class="rightColumn">
				...
				<li class="submit" style="background:none;">
	                ...
	                <sj:submit 
				            ...
				            <sj:a cssStyle="margin-left: 190px;margin-top: -45px;" button="true" href="#" onclick="resetForm('formone');">Reset</sj:a>
				             <sj:a cssStyle="margin-left: 5px;margin-top: -45px;" button="true" href="#" onclick="backForm();">Back</sj:a>
	               </div>
	               </li>
		     </ul>
			</div>
