...
function getResolutionTime(addressingTime,escalationTime,id)
{
  ...
  function(data){
    		       if(data.resolution_time == null){
        		      // alert("Inside If");
    		       $("#escalate_time"+id).val("NA");
    		    }
    		       else {
    		    	  // alert("Inside Else "+data.resolution_time);
    		          	   $("#escalate_time"+id).val(data.resolution_time);
    					}
    		   });
}
</SCRIPT>
					        ...
					        <div class="label" style="float:left; text-align:left; width:70%;">
					             <s:if test="%{mandatory}"><span class="needed"></span></s:if>
				                  <s:select 
				                              ...
				                              cssClass="select"
					                          cssStyle="width:82%"
				                              onchange="commonSelectAjaxCall('feedback_type','id','fb_type','dept_subdept',this.value,'module_name','moduleName','fb_type','ASC','fb_type2','Select Feedback Type');"
				                              >
				                  </s:select>
                           </div>
                   </div>
	 ...
	 <div style="float:left; width:90%;">
	   <s:iterator value="pageFieldsColumns" begin="0" end="0" status="status">
					        ...
					        <div class="label" style="float:left; text-align:left; width:70%;">
					             <s:if test="%{mandatory}"><span class="needed"></span></s:if>
				                  <s:select 
				                              ...
				                              cssClass="select"
					                          cssStyle="width:82%"
				                              onchange="commonSelectAjaxCall('feedback_type','id','fb_type','dept_subdept',this.value,'module_name','moduleName','fb_type','ASC','fb_type3','Select Feedback Type');"
				                              >
				                  </s:select>
                           </div>
                   </div>
					        ...
					        <div class="label" style="float:left; text-align:left; width:70%;">
					             <s:if test="%{mandatory}"><span class="needed"></span></s:if>
				                  <s:select 
				                              ...
				                              cssClass="select"
					                          cssStyle="width:82%"
				                              onchange="commonSelectAjaxCall('feedback_category','id','category_name','fb_type',this.value,'','','category_name','ASC','category_name3','Select Category');">
				                  </s:select>
                           </div>
                   </div>
	          </s:if>
	         ...
	         <s:if test="#status.odd">
              ...
              <s:else>
               <div style="float:left; width:50%;">
               <s:if test="key=='escalation_duration'">
		       <div class="label" style="float:left; width:24%;"><s:property value="%{value}"/>:</div>
				<div class="label" style="float:left; text-align:left; width:70%;">
	             	  <s:if test="%{mandatory}"><span class="needed"></span></s:if>
	             	 <s:select 
	           ...
	           <div class="label" style="float:left; width:24%;"><s:property value="%{value}"/>:</div>
				<div class="label" style="float:left; text-align:left; width:70%;">
	             	  <s:if test="%{mandatory}"><span class="needed"></span></s:if>
	             	<sj:datepicker name="%{key}" id="%{key}"  placeholder="Enter Data" readonly="true" onchange="getResolutionTime('addressing_time','resolution_time','');"  showOn="focus"  timepicker="true" timepickerOnly="true" timepickerGridHour="4" timepickerGridMinute="10" timepickerStepMinute="5" cssClass="textField" />
	           </div>
	           </s:else>
              </div>
              </s:else>
	         ...
	         <s:if test="#status.odd">
                   <div style="float:left; width:50%;">
                   <s:if test="key=='escalation_level'">
        			   <div class="label" style="float:left; width:24%;"><s:property value="%{value}"/>:</div>
					        <div class="label" style="float:left; text-align:left; width:70%;">
					             <s:if test="%{mandatory}"><span class="needed"></span></s:if>
				                  <s:select 
