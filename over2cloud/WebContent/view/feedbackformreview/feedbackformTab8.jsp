...
function backPrevious(val)
{
	...
	console.log("e " +$("#pname").val());
	
		$.ajax({
		    type : "post",
		    url : "/over2cloud/view/Over2Cloud/patientActivity/reviewQuestionnaireForms.action",
		    data:"pname="+pname+"&traceid="+traceId+"&type="+type+"&pageNo=9&positionPage="+positionPage+"&done="+done,
...
<table style="background-color: bisque; padding: 0px 0px; width: 100%;">
	...
	<s:form id="form1" action="" namespace="/view/Over2Cloud/patientActivity" method="post" enctype="multipart/form-data">
		...
		<tr>
			<td class="a"><label id="titlesection" style="color: #fff; " >GYNAECOLOGY</td>
			<td class="a"></td>
		</tr>
		<tr>
			
			<sj:datepicker value="" id="date1" name="601" label="1. Date of last menstrual period" />						
		</tr>	
		
		<tr>
			<td class="f" ><label id="labelAns" style="color: #000;" ><b>2. Are your menstrual periods regular</b></label></td>
			<td class="f" >		
		</tr>	
		
		<tr>
			<td width="500px" class="b"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Duration</label></td>
			<td width="500px" class="b"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="602" title="Menstrual periods regular Duration" name="602" style="height:20px;"> 
    ...
    <option value="27">27</option>     <option value="28">28</option>	<option value="29">29</option>     <option value="30">30</option>	<option value="31">31</option>     
		...
		<tr>
			...
			<td width="500px" class="f"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="603" title="Menstrual periods regular Flow" name="603" style="height:20px;"> 
    <option value="-1">Days</option> 
    <option value="1">1</option>     <option value="2">2</option> 
    <option value="3">3</option>     <option value="4">4</option>	<option value="5">5</option>     <option value="6">6</option>	<option value="7">7</option>     <option value="8">8</option>
    <option value="9">9</option>     <option value="10">10</option>	<option value="11">11</option>     <option value="12">12</option>	<option value="13">13</option>     <option value="14">14</option>
    ...
    <option value="27">27</option>     <option value="28">28</option>	<option value="29">29</option>     <option value="30">30</option>	<option value="31">31</option>     
		...
		<tr>
			<td width="500px" class="b"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Frequency</label></td>
			<td width="500px" class="c"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select title="Menstrual periods regular Frequency" id="604" name="604" style="height:20px;"> 
    ...
    <option value="Scanned">Scanned</option> 
		...
		<tr>
			<td width="500px" class="b"><label id="labelAns" style="color: #000;" ><b>4. Do you frequently suffer discomfort during menstruation?</b></label></td>
			<td width="500px" class="c"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yes<s:radio list="#{'Yes':''}" name="606"  title="Do you frequently suffer discomfort during menstruation?"  theme="simple"></s:radio>
			...
			<td width="500px" class="f"><label id="labelAns" style="color: #000;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yes<s:radio list="#{'Yes':''}" name="607"  title="Have you Attained Menopause?"  onclick="openDiv(this.value)" theme="simple"></s:radio>
			...
			<s:checkbox name="608"  onclick="click11(this.value,'dvPassport');" theme="simple" />
    ...
    <label id="labelAns" style="color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:label value="Reason" theme="simple"></s:label>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <s:textfield name="113" value="" size="18px" type="text" id="txtPassportNumber" style="height:20px" theme="simple"/></label><br><br>
    <label id="labelAns" style="color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:label value="Year of Surgery" theme="simple"></s:label>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield name="114" value="" size="18px" type="text" id="txtPassportNumber" style="height:20px" theme="simple"/></label>
			...
			<s:checkbox name="608"  onclick="click11(this.value,'dvPassport1');" theme="simple" />
			</div>
    ...
    <label id="labelAns" style="color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:label value="Duration" theme="simple"></s:label>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield name="115" value="" size="18px" type="text" id="txtPassportNumber1" style="height:20px" theme="simple"/></label>
</div>
		</td></tr>
			...
			<tr>
			<td width="500px" class="b"><label id="labelAns" style="color: #000;" ><b>7. Do you feel dominated by your family and society?</b></label></td>
			<td class="c">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield name="612" value="" title="Do you feel dominated by your Family and Society?"  theme="simple"/></td>
		</tr>
	<tr>
