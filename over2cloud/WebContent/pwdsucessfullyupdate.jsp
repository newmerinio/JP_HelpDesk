	...
	<div class="popoupdiv" style=" width:744px;">
		<div class="pop_content">
			...
			<div class="pop_up_content_inner">
				<div class="pop_up_content_inner_sub" style="width:430px; padding:5px 5px 0px 5px;">
					<h1>Congratulations !!!! Password Updated Sucessfully</h1>
					<div class="pop_up_forgot"><a href="http://www.over2cloud.com" style=" font-size:11px;">please click here <b>Login</b>, for any problems Contact support@over2cloud.com</a></div>
				</div>
			</div>
