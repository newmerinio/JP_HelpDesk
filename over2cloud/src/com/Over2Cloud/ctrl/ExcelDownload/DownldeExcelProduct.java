...
import com.Over2Cloud.ctrl.AllCommonModule.PrdouctCommonPropertyMap;
...
public class DownldeExcelProduct {
	/**
	 *  Define Constructure
	 */
	public DownldeExcelProduct() {
	}
	...
	public String createExcel(String titleString, String sheetString,String subTitleString, List data, String[] headerTitles,String titleKey, String filePath){
		...
		try{
    		...
    		List<ConfigurationUtilBean> titleMap = new PrdouctCommonPropertyMap().getTitles(titleKey);
			...
			file = filePath + File.separator + "ProductReport"
	...
	public String createPdf(List data,String[] headerTitles,String titleKey, String filePath)
	{
		...
		try {
			...
			fileName = filePath + File.separator + "Product Report"
			+ DateUtil.getCurrentDateIndianFormat()
