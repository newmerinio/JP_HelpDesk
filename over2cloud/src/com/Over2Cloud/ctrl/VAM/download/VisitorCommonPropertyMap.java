...
public class VisitorCommonPropertyMap {
	...
	SessionFactory connectionSpace=(SessionFactory)session.get("connectionSpace");
		...
		{	
			...
			try{
			List<GridDataPropertyView> basicfieldNames=Configuration.getColomnfieldList("mapped_visitor_configuration", accountID, connectionSpace,"visitor_configuration ");
			int l=0;
