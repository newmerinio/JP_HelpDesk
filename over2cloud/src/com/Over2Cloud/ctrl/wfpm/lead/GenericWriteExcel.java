...
public class GenericWriteExcel 
{
	...
	public String createExcel(String titleString,String subTitleString, List dataList, List headerTitle,String filePath,String fileName)
	   {
		//System.out.println("-------------inside createExcel() method--------------");
			response.reset();
			...
			try {
				...
				response.setHeader("Content-Disposition","attachment; filename="+subTitleString+"_"+DateUtil.getCurrentDateUSFormat().replaceAll("-", "_")+"_"+DateUtil.getCurrentTime().replaceAll(":", "_")+".xls");
