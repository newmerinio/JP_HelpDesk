...
public class HrEveningReport extends Thread{

	//HelpdeskServiceFileHelper HSFH = new HelpdeskServiceFileHelper();
	HRReportHelper HRR = null;
	...
	public HrEveningReport(SessionFactory connection,HRReportHelper HUHObj,CommunicationHelper CHObj)
	  {
	...
	public HrEveningReport(){
		 HRR=new HRReportHelper();
